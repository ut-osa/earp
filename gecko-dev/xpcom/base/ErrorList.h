...
#define MODULE NS_ERROR_MODULE_DOM_RDB
  ERROR(NS_ERROR_DOM_RDB_UNKNOWN_ERR,               FAILURE(1)),
  ERROR(NS_ERROR_DOM_RDB_NOT_FOUND_ERR,             FAILURE(3)),
  ERROR(NS_ERROR_DOM_RDB_CONSTRAINT_ERR,            FAILURE(4)),
  ERROR(NS_ERROR_DOM_RDB_DATA_ERR,                  FAILURE(5)),
  ERROR(NS_ERROR_DOM_RDB_NOT_ALLOWED_ERR,           FAILURE(6)),
  ERROR(NS_ERROR_DOM_RDB_TRANSACTION_INACTIVE_ERR,  FAILURE(7)),
  ERROR(NS_ERROR_DOM_RDB_ABORT_ERR,                 FAILURE(8)),
  ERROR(NS_ERROR_DOM_RDB_READ_ONLY_ERR,             FAILURE(9)),
  ERROR(NS_ERROR_DOM_RDB_TIMEOUT_ERR,               FAILURE(10)),
  ERROR(NS_ERROR_DOM_RDB_QUOTA_ERR,                 FAILURE(11)),
  ERROR(NS_ERROR_DOM_RDB_VERSION_ERR,               FAILURE(12)),
  ERROR(NS_ERROR_DOM_RDB_RECOVERABLE_ERR,           FAILURE(1001)),
#undef MODULE
