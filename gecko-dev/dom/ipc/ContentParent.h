...
public:
    ...
    virtual PRDBParent* AllocPRDBParent() MOZ_OVERRIDE;
    virtual bool
    RecvPRDBConstructor(PRDBParent* aActor) MOZ_OVERRIDE;
...
private:
    ...
    virtual bool DeallocPRDBParent(PRDBParent* aActor) MOZ_OVERRIDE;
