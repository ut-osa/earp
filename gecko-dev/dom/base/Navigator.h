...
public:
  ...
  void GetDeviceStorages(const nsAString& aType,
                         ...
                         ErrorResult& aRv);
  //already_AddRefed<nsDOMRDB> GetRDB(const nsAString& aName, ErrorResult& aRv);
  nsDOMRDB* GetRDB(const nsAString& aName, ErrorResult& aRv);
  already_AddRefed<RDBSubsetDesc> GetReceivedRDBDesc(uint64_t aToken, ErrorResult& aRv);
  already_AddRefed<RDBIAC> ConnectRDBIAC(const nsAString& aName, ErrorResult& aRv);
  RDBIAS* RegisterRDBIAS(const nsAString& aName, ErrorResult& aRv);
...
private:
  ...
  nsTArray<nsRefPtr<nsDOMRDB> > mRDBs;
