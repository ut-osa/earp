...
(function(exports) {
  ...
  PermissionManager.prototype = {
    ...
    start: function pm_start() {
      ...
      //this.view_def  = document.getElementById('view_def');
      ...
      //this.view_def.addEventListener('click',
        //function onClick() { self.view_def.focus() }
        //);
    ...
    clickHandler: function pm_clickHandler(evt) {
      ...
      if (evt.target === this.yes && this.yes.callback) {
        ...
        ///////// VIEW MOD CODE ///////////////
        // XXX Could probably move this into the yes callback
        // eventually leave it hear for our first go
        /*if(this.view_def.value.length > 0){
            console.log("Setting view to: " + this.view_def.value +
                  "\nfor: " + this.currentOrigin);
            db = navigator.getRDB(this.permissionType); // XXX not sure
            db.defineViewFor([this.currentOrigin], view_def.value);
        }*/
        ///////////////////////////////////////
