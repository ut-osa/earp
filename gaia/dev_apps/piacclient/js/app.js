var iac = navigator.portRDBIACManager.connect("app-piacserver.gaiamobile.org/TestInterAppService");
iac.onsuccess = function() {alert('connected')}
iac.onerror = function() {alert('failed to connect')}
