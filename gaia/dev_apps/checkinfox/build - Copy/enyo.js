...
(function () {
    ...
    enyo = window.enyo || {
        ...
        for (var t, o, n = document.getElementsByTagName("script"), a = n.length - 1, r = e.length; a >= 0 && (t = n[a]); a--)
            if (!t.located && (o = t.getAttribute("src") || "", o.slice(-r) == e)) return t.located = !0, {
...
(function (e, t) {
    ...
    t.ready = function (e, n) {
        ...
        (s = "interactive" === i.readyState) && (~t.indexOf(e.type, ["DOMContentLoaded", "readystatechange"]) || (o(e.type, a), d())), (s = "complete" === i.readyState || "loaded" === i.readyState) && (o(e.type, a), d())
    }, r = function (e, t) {
        var n = i.addEventListener ? "addEventListener" : "attachEvent",
            a = "attachEvent" === n ? "on" : "";
        i[n](a + e, t, !1)
    }, o = function (e, t) {
        var n = i.addEventListener ? "removeEventListener" : "detachEvent",
            a = "detachEvent" === n ? "on" : "";
        i[n](a + e, t, !1)
    }, d = function () {
        if (s && c.length)
            for (; c.length;) n.apply(e, c.shift());
        y = !1
...
(function () {
    enyo = window.enyo || {
        ...
        rewrite: function (e) {
            var t, a = this.includeTrailingSlash,
                i = this.paths,
                n = function (e, n) {
                    return t = !0, a(i[n]) || ""
                }, o = e;
        ...
        this.machine = e, this.packages = [], this.modules = [], this.sheets = [], this.designs = [], this.stack = [], this.pathResolver = t || enyo.path, this.packageName = "", this.packageFolder = "", this.finishCallbacks = {}
        ...
        more: function (e) {
            if (!e || !this.continueBlock(e)) {
                ...
                t ? (enyo.runtimeLoading && e.failed && (t.failed = t.failed || [], t.failed.push.apply(t.failed, e.failed)), this.verbose && window.console.groupEnd("* finish package (" + (t.packageName || "anon") + ")"), this.packageFolder = t.folder, this.packageName = "", this.more(t)) : this.finish(e)
            }
        },
        finish: function (e) {
            this.packageFolder = "", this.verbose && window.console.log("-------------- fini");
            for (var t in this.finishCallbacks)
                if (this.finishCallbacks[t]) {
        ...
        require: function (e, t) {
            var a = this.pathResolver.rewrite(e),
                i = this.getPathPrefix(e);
            if (a = i + a, ".css" == a.slice(-4).toLowerCase() || ".less" == a.slice(-5).toLowerCase()) this.verbose && window.console.log("+ stylesheet: [" + i + "][" + e + "]"), this.requireStylesheet(a);
            else {
                if (".js" == a.slice(-3).toLowerCase() && "package.js" != a.slice(-10).toLowerCase()) return this.verbose && window.console.log("+ module: [" + i + "][" + e + "]"), this.requireScript(e, a, t);
                if (".design" != a.slice(-7).toLowerCase()) return this.requirePackage(a, t), !0;
                this.verbose && window.console.log("+ design metadata: [" + i + "][" + e + "]"), this.requireDesign(a)
            }
        },
        ...
        decodePackagePath: function (e) {
            var t = "",
                a = "package.js",
                i = e.replace(/\\/g, "/").replace(/\/\//g, "/").replace(/:\//, "://").split("/");
            if (i.length) {
                var n = i.pop() || i.pop() || "";
                n.slice(-a.length) !== a ? i.push(n) : a = n, t = i.join("/"), t = t ? t + "/" : "", a = t + a
            }
            return {
                folder: t,
                manifest: a
        ...
        requirePackage: function (e, t) {
            ...
            this.manifest = a.manifest, this.packageFolder = a.folder, t.packageName = this.packageName, this.stack.push(t), this.report("loading package", this.packageName), this.verbose && window.console.group("* start package [" + this.packageName + "]"), this.loadPackage(this.manifest)
        }
    }
})();
...
function () {
    ...
    t.ready(function () {
        ...
        if (n) a.push(arguments), t.runtimeLoading || (t.runtimeLoading = !0, e());
        else if (t.isArray(i))
            for (var o = 0; i.length > o; ++o) t.loader.require(i[o]);
        else t.loader.require(i)
    }
}(), enyo.path.addPaths({
    enyo: enyo.args.root,
    lib: "$enyo/../lib"
...
(function () {
    ...
    enyo.lastIndexOf = function (e, n, t) {
        ...
        var o, r = "string" == typeof n,
            i = (r ? n.split("") : n).reverse(),
            a = i.length - 1,
            s = n.length;
        return r && (i = i.join("")), o = enyo.indexOf(e, i, s - (t || s)), r || i.reverse(), -1 === o ? o : a - o
    };
    var t = enyo.lastIndexOf,
        o = function (e) {
            return e && "function" == typeof e && (e._FinalCtor || e._finishKindCreation)
        };
    enyo.getPath = function (e) {
        if (void 0 === e || null === e) return e;
        var n = this === enyo ? enyo.global : this,
            t = "." == e[0] ? e.replace(/^\.+/, "") : e;
        if (!t) return n;
        for (var o, r, i, a = t.split("."), s = a.pop(), c = 0;
            (i = a[c]) && (n && (n._isObject ? n = n._getters && (r = n._getters[i]) ? n[r]() : n.computed && n.get && null != n.computed[i] ? n[i]() : n[i] : ("function" == typeof n && (n = enyo.checkConstructor(n)), n = n[i])), n); ++c);
        return c == a.length ? (o = n[s], "function" == typeof o && enyo.checkConstructor(o) || o) : void 0
    }, enyo.getPath.fast = function (e) {
        var n, t, o = this;
        return t = o._getters && (n = o._getters[e]) ? o[n]() : o.get && o.computed && null != o.computed[e] ? o[e]() : o[e], "function" == typeof t && enyo.checkConstructor(t) || t
    }, enyo.setPath = function (e, n, t) {
        var r = this === enyo ? enyo.global : this,
            i = r;
        if (!e) return r;
        ...
        return c = r && r._isObject && r._getters && (u = r._getters[y]) ? r[u]() : r[y], r[y] = n, (r.notifyObservers && c !== n || t) && r.notifyObservers(y, c, n), i
    }, enyo.setPath.fast = function (e, n) {
        var t, o, r = this;
        return r.computed && null != r.computed[e] ? r : (t = r._getters && (o = r._getters[e]) ? r[o]() : r[e], r[e] = n, t !== n && r.notifyObservers(e, t, n), r)
    }, enyo.uid = function (n) {
        return (n ? n : "") + e+++""
    ...
    enyo.isString = function (e) {
        ...
        var o, r, i, a = enyo.isArray(e) && e,
            s = t || enyo.global,
            c = n,
            u = 0;
        if (a && c && enyo.isFunction(c))
            for (r = enyo.clone(a), o = a.length; o > u; ++u)
                if (i = c.call(s, a[u], u, r)) return u;
        return !1
    }, enyo.indexOf = function (e, n, t) {
        if (n.indexOf) return n.indexOf(e, t);
        if (t && (0 > t && (t = 0), t > n.length)) return -1;
        for (var o, r = t || 0, i = n.length;
            (o = n[r]) || i > r; r++)
            if (o == e) return r;
        return -1
        ...
        if (e) {
            var o = t || this;
            if (enyo.isArray(e) && e.forEach) e.forEach(n, o);
            else
                for (var r = Object(e), i = r.length >>> 0, a = 0; i > a; a++) a in r && n.call(o, r[a], a, r)
        }
    ...
    enyo.values = function (e) {
        ...
        for (var e, n = Array.prototype.concat.apply([], arguments), o = [], r = [], i = 0, a = n.length; a > i; ++i) e = n[i], ~enyo.indexOf(e, o) || (o.push(e), i === t(e, n) && r.push(e));
        return r
    };
    var a = enyo.union;
    enyo.unique = a;
    ...
    enyo.reduce = i, enyo.only = function (e, t, o) {
        ...
        var c = enyo.clone(t);
        for (o = n(o) && "function" == typeof o ? o : void 0, i = t.length; i > s; ++s) r = t[s], n(r) && n(r[e]) && (o ? o(e, r, a, c) : a[r[e]] = r);
        return a
        ...
        if (!{
            ...
            for (var r, i = ["toString", "toLocaleString", "valueOf", "hasOwnProperty", "isPrototypeOf", "propertyIsEnumerable", "constructor"], a = 0; r = i[a]; a++) t.call(e, r) && n.push(r);
        return n
    };
    var c = enyo.keys;
    ...
    enyo.mixin = function (e, n, t) {
        var o, r, i, a, s, c;
        if (enyo.isArray(e) ? (o = {}, r = e, n && enyo.isObject(n) && (i = n)) : (o = e || {}, r = n, i = t), enyo.isObject(i) || (i = {}), !0 === t && (i.ignore = !0, i.exists = !0), enyo.isArray(r))
            for (a = 0; c = r[a]; ++a) enyo.mixin(o, c, i);
        else
            for (s in r) c = r[s], u[s] !== c && (i.exists && !c || i.ignore && o[s] || (i.filter && enyo.isFunction(i.filter) ? !i.filter(s, c, r, o, i) : 0) || (o[s] = c));
        return o
    ...
    }(), enyo.nop = function () {}, enyo.nob = {}, enyo.nar = [], enyo.instance = function () {}, enyo.setPrototype || (enyo.setPrototype = function (e, n) {
        e.prototype = n
...
(function () {
    ...
    function e(e) {
        enyo.mixin(this, e), n[this.name] = this, !0 !== this.average || t[this.name] || (t[this.name] = []), t[this.name] && !1 !== this.average && (this._averaging = !0), !0 === this.autoStart && this.start()
    }
    ...
    enyo.dev = {
        ...
        clear: function (e) {
            ...
            return o ? (o.complete && o.complete(), o[e] instanceof Array ? o[e] = [] : delete o[e], !0) : !1
        }
    }, e.prototype = {
        logging: !0,
        autoStart: !0,
        ...
        _time: null,
        start: function () {
            return !0 === this._started ? !1 : (this._log("starting benchmark"), this._begin = enyo.bench(), this._started = !0, !0)
        },
        stop: function () {
            return this._started ? (this._end = enyo.bench(), this._time = this._end - this._begin, this._log("benchmark complete: " + this._time), !0 === this._averaging && t[this.name].push(this._time), this._started = !1, !0) : !1
        },
        _log: function (e) {
...
enyo.kind = function (e) {
    ...
    }, e.statics && enyo.mixin(t, e.statics), t.extend = enyo.kind.statics.extend, t._deferred = !0, n && !enyo.getPath(n) || enyo.kind.allowOverride ? enyo.setPath(n, t) : n && enyo.error("enyo.kind: " + n + " is already in use by another " + "kind, all kind definitions must have unique names."), t
    ...
    var t = "kind" in e,
        o = e.kind;
    delete e.kind;
    var r = enyo.constructorForKind(o),
        i = r && r.prototype || null;
    ...
    var e = function () {
        ...
        var n;
        return this._constructor && (n = this._constructor.apply(this, arguments)), this.constructed && this.constructed.apply(this, arguments), n ? n : void 0
    };
    return e
}, enyo.kind.defaultNamespace = "enyo", enyo.kind.features = [], enyo.kind.extendMethods = function (e, n, t) {
    var o = e.prototype || e,
        r = o.base;
    !o.inherited && r && (o.inherited = enyo.kind.inherited), n.hasOwnProperty("constructor") && (n._constructor = n.constructor, delete n.constructor);
    for (var i in n) {
        var a = n[i];
        enyo.isInherited(a) && (a = o[i] = t ? a.fn(o[i] || enyo.nop) : a.fn(r ? r.prototype[i] || enyo.nop : enyo.nop)), enyo.isFunction(a) && (t ? (o[i] = a, a.displayName = i + "()") : (a._inherited = r ? r.prototype[i] : null, a.displayName = o.kindName + "." + i + "()"))
    }
...
function (e) {
    ...
    e.subclass || (e.subclass = enyo.kind.statics.subclass), e.extend || (e.extend = enyo.kind.statics.extend), n.statics && (enyo.mixin(e, n.statics), delete e.prototype.statics), n.protectedStatics && (enyo.mixin(e, n.protectedStatics), delete e.prototype.protectedStatics);
    for (var t = e.prototype.base; t;) t.subclass(e, n), t = t.prototype.base
}), enyo.kind.statics = {
    subclass: function () {},
    extend: function (e, n) {
        var t, o, r = this,
            i = enyo.isArray(e) ? e : [e];
        o = function (e, n) {
            return !(enyo.isFunction(n) || enyo.isInherited(n))
        }, !n && r._deferred && (r = enyo.checkConstructor(r)), t = n || r.prototype;
        for (var a, s = 0; a = i[s]; ++s) enyo.concatHandler(t, a), enyo.kind.extendMethods(t, a, !0), enyo.mixin(t, a, {
            filter: o
        });
        return n || r
    }
}, enyo.concatHandler = function (e, n) {
    for (var t = e.prototype || e, o = t.ctor, r = t === e; o;) o.concat && o.concat(e, n, r), o = o.prototype.base
    ...
    if (n) return n;
    if (n = enyo.Theme[e] || enyo[e] || enyo.getPath("enyo." + e) || window[e] || enyo.getPath(e), n && n._finishKindCreation && (n = n._finishKindCreation()), !enyo.isFunction(n)) throw "[" + e + "] is not the name of a valid kind.";
...
(function (e) {
    ...
    e.BindingCount = 0, e.kind({
        ...
        constructor: function (n) {
            n && e.mixin(this, n), this.id = e.uid("binding"), t[this.id] = this, this.originals = this.originals || {}, this.originals.from = this.from, this.originals.to = this.to, this.originals.source = this.source, this.originals.target = this.target, this.initTransform(), this.refresh(), e.BindingCount++
        },
        isConnected: function () {
            return this.connected = this.sourceConnected && this.targetConnected, this.connected
        },
        registered: function (e, t) {
            "source" == e ? (this.sourceRegistered = !0, this.registeredSource = t) : "target" == e && (this.targetRegistered = !0, this.registeredTarget = t), this.autoSync && this.isRegistered() && !this.synchronizing && this.sync()
        },
        ...
        syncFromSource: function () {
            if (!this.synchronizing) {
                if (this.synchronizing = !0, this.isConnected() && this.isRegistered()) {
                    var e = this.getSourceValue(),
                        t = this.transform;
                    t && "function" == typeof t && (e = t.call(this.owner || this, e, "source", this)), (this.allowUndefined || void 0 !== e) && this.setTargetValue(e)
                }
            ...
            if (!this.oneWay && !this.synchronizing) {
                if (this.synchronizing = !0, this.isConnected() && this.isRegistered()) {
                    var e = this.getTargetValue(),
                        t = this.transform;
                    t && "function" == typeof t && (e = t.call(this.owner || this, e, "target", this)), (this.allowUndefined || void 0 !== e) && this.setSourceValue(e)
                }
                this.synchronizing = !1
            }
        },
        resolve: function () {
            var t, n, o = this.source,
                r = this.target,
                i = this.from,
                s = this.to;
            if (i && s) {
                if (this.building) {
                    ...
                    o || (this.source = o = "." == i[0] ? this.owner : e.global), r || (this.target = r = "." == s[0] ? this.owner : e.global), n = i.slice(1).split("."), t = s.slice(1).split(".");
                    var a = e.lastIndexOf(".", i),
                        c = e.lastIndexOf(".", s);
                    this.sourcePath = ("^" == i[0] ? n.slice(0, -1) : n).join("."), this.targetPath = ("^" == s[0] ? t.slice(0, -1) : t).join("."), this.sourceProp = a > -1 && "$" == i[a - 1] ? n.slice(-2).join(".") : n.pop(), this.targetProp = c > -1 && "$" == i[c - 1] ? t.slice(-2).join(".") : t.pop(), this.building = !1
                }
                return o === e.global && (this.source = e.getPath(this.sourcePath), this.sourceGlobal = !0), r === e.global && (t = this.targetPath.split("."), this.targetGlobalPath = t.slice(0, -1).join("."), this.targetPath = t.pop(), this.target = e.getPath(this.targetGlobalPath), this.targetGlobal = !0), this
            }
        },
        connectSource: function () {
            var t = this.source,
                n = this.sourceGlobal ? this.sourceProp : this.sourcePath,
                o = this.sourceObserver,
                r = this.sourceObserverId || (this.sourceObserverId = e.uid("__bindingObserver__"));
            t === e.global && (t = this.resolve().source), t && t.addObserver && !this.sourceConnected ? (o || (o = this.sourceObserver = e.bindSafely(this, this.syncFromSource), o.binding = this, o.bindingProp = "source"), this.sourceConnected = !0, this.sourceObserver = t.addObserver(n, o, null, r)) : this.sourceConnected = !1
        },
        connectTarget: function () {
            var t = this.target,
                n = this.targetGlobal ? this.targetProp : this.targetPath,
                o = this.targetObserver,
                r = this.targetObserverId || (this.targetObserverId = e.uid("__bindingObserver__"));
            t === e.global && (t = this.resolve().target), t && t.addObserver && !this.targetConnected ? (!o && n && (o = this.targetObserver = e.bindSafely(this, this.syncFromTarget), o.binding = this, o.bindingProp = "target"), this.targetConnected = !0, n ? this.targetObserver = t.addObserver(n, o, null, r) : this.registered("target", this.target)) : this.targetConnected = !1
        },
        disconnectSource: function () {
            if (this.source && this.sourceConnected) {
                var t = this.source,
                    n = this.sourceObserver,
                    o = this.sourceObserverId,
                    r = e._observerMap[t.objectObserverId],
                    i = r && r[o];
        ...
        disconnectTarget: function () {
            if (this.target && this.targetConnected) {
                var t = this.target,
                    n = this.targetObserver,
                    o = this.targetObserverId,
                    r = e._observerMap[t.objectObserverId],
                    i = r && r[o];
        ...
        connect: function () {
            ...
            return e || (this.connecting = !0, this.sourceConnected || this.connectSource(), this.targetConnected || this.connectTarget(), this.connecting = !1, this.isConnected()), this.connected && !e && this.autoSync && this.sync(), this
        },
        sync: function () {
        ...
        reset: function () {
            return this.disconnect(), e.mixin(this, this.originals), this.building = !0, this.stop = !1, this.sourceRegistered = !1, this.targetRegistered = !1, this.registeredSource = null, this.registeredTarget = null, this
        },
        stop: function () {
            this.stop = !0
        },
        ...
        destroy: function () {
            this.disconnect(), this.destroyed = !0, this.source = null, this.target = null, this.registeredSource = null, this.registeredTarget = null, this.sourceObserver = null, this.targetObserver = null, this.transform = null, this.originals = null, this.owner && (this.owner.removeBinding(this), this.owner = null), delete t[this.id], e.BindingCount--
        },
        initTransform: function () {
            var t = this.transform,
                n = this.owner,
                o = n ? n.bindingTransformOwner : null;
            t && e.isString(t) && ((o || n) && (t = e.getPath.call(o || n, this.transform), !t && o && n && (t = e.getPath.call(n, this.transform))), t || (t = e.getPath(this.transform))), this.transform = e.isFunction(t) ? t : null
        }
...
(function (e) {
    var t = function (t, n) {
        var i, o = t._appliedMixins,
            r = n;
        if (e.isString(r) && (r = e.getPath(r), !r)) return e.warn("could not find the requested mixin " + n), void 0;
        if (r.name) {
            if (~e.indexOf(r.name, o)) return e.warn("attempt to add the same mixin more than once, " + r.name + " onto -> " + t.kindName), void 0;
            o.push(r.name), i = r.name, delete r.name
        } else i = null;
        var s = e.clone(r);
        r.hasOwnProperty("constructor") && (s._constructor = r.constructor, delete s.constructor), e.kind.statics.extend(s, t), i && (r.name = i)
    }, n = function (n, i) {
            if (i.mixins) {
                var o = n.prototype || n,
                    r = i.mixins;
...
(function (e) {
    var t = function (t) {
        return t.hasOwnProperty("observerMap") || (t.observerMap = e.clone(t.observerMap)), t.observerMap
    }, n = e._observerMap = {};
    e.ObserverSupport = {
        name: "ObserverSupport",
        addObserver: function (r, i, o) {
            var s, a, c = ("." == r[0] ? r.slice(1) : r).split("."),
                u = c.shift(),
                h = i,
                l = arguments[3],
                d = arguments[4],
                f = l || i.observerId || e.uid("__observer__"),
                y = t(this),
                p = this.objectObserverId || (this.objectObserverId = e.uid("__objectObserverId__")),
                g = n[p] || (n[p] = {}),
                v = g[f] || (g[f] = {});
            return d && d.chain && (v.chain = d.chain), "$" == u && (u = u + "." + c.shift()), c.length && (v.chain = v.chain || [], r = c.join("."), i = e.bindSafely(this, "updateObserver", r, h, o, f, v), a = this.get(u)), (s = y[u]) ? ("string" == typeof s && (s = y[u] = e.trim(s).split(" ")), s.push(f)) : y[u] = [f], i = this[f] = o ? e.bindSafely(o, i) : i, i.observer = !0, v.observerId = f, v.observerProp = u, v.observerOwner = this, v.objectObserverId = p, v.observer = i, v.chain && v.chain.push(v), a && a.addObserver && a.addObserver(r, h, o, f, v), i
        },
        ...
        removeChainedObservers: function (t) {
            for (var r, i = n[this.objectObserverId], o = i[t], s = e.find(o.chain, function (e) {
                    return e === o
                }), a = o.chain.splice(s + 1, o.chain.length), c = 0; r = a[c]; ++c) r.chain = null, r.observerOwner.removeObserver(r.observerProp, r.observer), n[r.objectObserverId][r.observerId] = void 0
        },
        removeObserver: function (r, i) {
            var o, s, a = t(this),
                c = n[this.objectObserverId];
            if (s = a[r]) {
                "string" == typeof s && (s = a[r] = e.trim(s).split(" "));
                for (var u, h, l = 0; u = s[l]; ++l)((h = this[u]) && i && h === i || !i) && (s.splice(l, 1), o = c && c[u], o && o.chain && this.removeChainedObservers(u), h.observer && (c[u] = void 0, delete this[u]));
        ...
        notifyObservers: function (n, r, i) {
            ...
            if (o) {
                ...
                if ("string" == typeof s && (s = o[n] = e.trim(s).split(" ")), o["*"] && ("string" == typeof o["*"] && (o["*"] = e.trim(o["*"]).split(" ")), s = s ? s.concat(o["*"]) : o["*"]), s && s.length) {
                    s = s.slice();
        ...
        stopNotifications: function (e) {
            return this.observerNotificationsEnabled = !1, this.observerStopCount += 1, e && this.disableNotificationQueue(), this
        },
        startNotifications: function (e) {
            return 0 !== this.observerStopCount && (this.observerStopCount -= 1), 0 === this.observerStopCount && (this.observerNotificationsEnabled = !0, this._flushObserverQueue()), e && this.enableNotificationQueue(), this
        },
        enableNotificationQueue: function () {
            return this.observerNotificationQueueEnabled = !0, this
        },
        disableNotificationQueue: function () {
            return this.observerNotificationQueueEnabled = !1, this.observerNotificationQueue = {}, this
        },
    ...
    e.concatHandler = function (t, n) {
        ...
        if (n.observers) {
            o.observers ? (o.observers = e.clone(o.observers), o.observerMap = e.clone(o.observerMap)) : (o.observers = {}, o.observerMap = {});
            for (var a in n.observers) {
                o.observers[a] = o.observers[a] || "";
                for (var c, u = "string" == typeof n.observers[a] ? e.trim(n.observers[a]).split(" ") : n.observers[a], h = 0; c = u[h]; ++h)~ o.observers[a].indexOf(c) || (o.observers[a] += " " + c, o.observerMap[c] = e.trim((o.observerMap[c] || "") + " " + a).replace(/\s+/g, " "));
...
(function (e) {
    ...
    e.ComputedSupport = {
        ...
        _getComputed: function (e) {
            var n, r = t(this, "computedCached"),
                o = t(this, "computedConfig"),
                i = o ? t(o, e) : null;
            if (n = r[e]) return "object" != typeof n && (n = r[e] = {}, i && i.hasOwnProperty("defaultValue") ? (n.dirty = !1, n.value = i.defaultValue) : n.dirty = !0), n.dirty && (n.value = this[e](), n.dirty = !1), n.value;
        ...
        _markComputed: function (e) {
            var n, r = t(this, "computedCached"),
                o = this.computedQueue || (this.computedQueue = {}),
                i = null;
            (n = r[e]) && ("object" != typeof n && (n = r[e] = {}), i = n.value, n.dirty = !0), o[e] = i
        },
    ...
    e.concatHandler = function (t, r) {
        if (n.apply(this, arguments), r.computed) {
            var o = t.prototype || t;
            o.computed ? (o.computed = e.clone(o.computed), o.computedCached = e.clone(o.computedCached), o.computedMap = e.clone(o.computedMap), o.computedConfig = e.clone(o.computedConfig)) : (o.computed = {}, o.computedCached = {}, o.computedMap = {}, o.computedConfig = {});
            for (var i in r.computed) {
                o.computed[i] = o.computed[i] || "";
                for (var s, a = "string" == typeof r.computed[i] ? e.trim(r.computed[i]).split(" ") : r.computed[i], c = 0; s = a[c]; ++c) "object" == typeof s ? (s.cached === !0 && (o.computedCached[i] = !0), o.computedConfig[i] = o.computedConfig[i] ? e.mixin(e.clone(o.computedConfig[i]), s) : s) : ~o.computed[i].indexOf(s) || (o.computed[i] += " " + s, o.computedMap[s] = e.trim((o.computedMap[s] || "") + " " + i).replace(/\s+/g, " "));
...
enyo.BindingSupport = {
    name: "BindingSupport",
    binding: function () {
        var e, t = enyo.toArray(arguments),
            n = enyo.mixin(t),
            i = this.bindings || (this.bindings = []);
        return n.owner = n.owner || this, n.kind = n.kind || this.defaultBindingKind || enyo.defaultBindingKind, this.bindingSupportInitialized === !1 ? i.push(n) : (enyo.isFunction(n.kind) || (n.kind = enyo.getPath(n.kind)), i.push(e = new n.kind(n))), e
    },
    ...
    refreshBindings: function (e) {
        var t = e || this.bindings;
        if (t)
            for (var n, i = 0; n = t[i]; ++i) n.refresh()
    },
    rebuildBindings: function (e) {
        var t = e || this.bindings;
        if (t)
            for (var n, i = 0; n = t[i]; ++i) n.rebuild()
    },
    ...
    destroy: enyo.inherit(function (e) {
        return function () {
            var t = this.bindings;
            if (t)
                for (var n, i = t.length - 1; n = t[i]; --i) n.destroy();
    ...
    addObserver: enyo.inherit(function (e) {
        return function (t, n) {
            var i, r = e.apply(this, arguments),
                o = this;
            return n.binding && ((-1 === (i = enyo.lastIndexOf(".", t)) || 1 === i && "$" == t[0] && ("source" == n.bindingProp || (o = this.get(t)))) && n.binding.registered(n.bindingProp, o), r.binding = n.binding), r
        }
    }),
...
(function (e) {
    ...
    e.RegisteredEventSupport = {
        ...
        addListener: function (n, i, r) {
            var o = this.eventId || (this.eventId = e.uid("__eventId__")),
                s = t[o] || (t[o] = {}),
                a = s[n] || (s[n] = []);
...
enyo.kind({
    ...
    importProps: function (e) {
        if (e) {
            var t;
            if (enyo.concatHandler(this, e), e.kindName)
    ...
    log: function () {
        var e = arguments.callee.caller,
            t = ((e ? e.displayName : "") || "(instance method)") + ":";
    ...
    _log: function (e, t) {
        if (enyo.logging.shouldLog(e)) try {
            ...
            enyo.logging._log(e, [t.callee.caller.displayName + ": "].concat(enyo.cloneArray(t))), enyo.log(n.stack)
        }
    },
    get: function () {
...
enyo.kind({
    ...
    makeId: function () {
        var e = "_",
            t = this.owner && this.owner.getId(),
            n = this.name || "@@" + ++enyo.Component._unnamedKindNumber;
        return (t ? t + e : "") + n
    },
    ...
    nameComponent: function (e) {
        var t, n = enyo.Component.prefixFromKindName(e.kindName),
            i = this._componentNameMap[n] || 0;
        do t = n + (++i > 1 ? i + "" : ""); while (this.$[t]);
        return this._componentNameMap[n] = Number(i), e.name = t, e.name
    },
    addComponent: function (e) {
        var t = e.getName();
        t || (t = this.nameComponent(e)), this.$[t] && this.warn('Duplicate component name "' + t + '" in owner "' + this.id + '" violates ' + "unique-name-under-owner rule, replacing existing component in the hash and continuing, " + "but this is an error condition and should be fixed."), this.$[t] = e, this.notifyObservers("$." + t, null, e)
    },
    ...
    dispatchEvent: function (e, t, n) {
        if (!this._silenced) {
            ...
            if (this.decorateEvent !== enyo.Component.prototype.decorateEvent && this.decorateEvent(e, t, n), o && o.owner === this) {
                ...
                if (this[e] && enyo.isString(this[e])) return t.delegate = this, i = this.bubbleUp(this[e], t, n), delete t.delegate, i
            }
        }
    },
    ...
    stopAllJobs: function () {
        if (this.__jobs)
            for (var e in this.__jobs) this.stopJob(e)
    },
    ...
    waterfall: function (e, t, n) {
        return this._silenced ? void 0 : (t = t || {}, this.dispatchEvent(e, t, n) ? !0 : (this.waterfallDown(e, t, n || this), void 0))
    },
    waterfallDown: function (e, t, n) {
        if (!this._silenced)
            for (var i in this.$) this.$[i].waterfall(e, t, n)
    },
    _silenced: !1,
    _silenceCount: 0,
    silence: function () {
    ...
    for (var o = 0; e.length > o; o++) {
        var r = enyo.clone(e[o]),
            s = t[r.name],
            a = enyo.constructorForKind(r.kind || n);
        if (s) {
            enyo.concatHandler(r, s);
            for (var c = r.kind && ("string" == typeof r.kind && enyo.getPath(r.kind) || "function" == typeof r.kind && r.kind) || enyo.defaultCtor; c;) c.concat && c.concat(r, s, !0), c = c.prototype.base;
            enyo.mixin(r, s, {
                filter: i
            })
        }
        r.components && (r.components = enyo.Component.overrideComponents(r.components, t, a.prototype.defaultKind)), e[o] = r
    }
    return e
    ...
    var i, o;
    enyo.isString(t) ? ("on" != e.slice(0, 2) && (enyo.warn("enyo.Component.addEvent: event names must start with 'on'. " + n.kindName + " event '" + e + "' was auto-corrected to 'on" + e + "'."), e = "on" + e), i = t, o = "do" + enyo.cap(e.slice(2))) : (i = t.value, o = t.caller), n[e] = i, n[o] || (n[o] = function (t) {
        var n = t;
        n || (n = {});
        var i = n.delegate;
...
enyo.kind({
    ...
    controllerChanged: function () {
        ...
        e && enyo.isString(e) && (this.warn("the `controller` properties special handling has been deprecated, please use bindings to help resolve paths as this feature will be removed"), e = this.controller = enyo.getPath.call("." == e[0] ? this : enyo.global, e))
    },
    create: enyo.inherit(function (e) {
        return function () {
            this.controls = this.controls || [], this.children = this.children || [], this.containerChanged(), e.apply(this, arguments), this.layoutKindChanged(), this.controller && this.notifyObservers("controller", null, this.controller)
        }
    }),
    destroy: enyo.inherit(function (e) {
        return function () {
    ...
    addChild: function (e, n) {
        if (this.controlParent) this.controlParent.addChild(e, n);
        else if (e.setParent(this), void 0 !== n) {
...
(function (e) {
    ...
    e.ready(function () {
        ...
        addRoute: function (e) {
            var t, n = this._staticRoutes,
                o = this._dynamicRoutes;
            return !0 === e["default"] ? this.defaultRoute = e : i.test(e.path) ? (t = RegExp(e.path.replace(i, "([a-zA-Z0-9-]*)")), e.regex = t, o.push(e)) : n[e.path] = e, this
        },
        constructor: e.inherit(function (e) {
            return function () {
                this._staticRoutes = {}, this._dynamicRoutes = [], this.routes = this.routes || [], this._history = this._history || [], e.apply(this, arguments)
            }
        }),
        create: e.inherit(function (e) {
            return function () {
                e.apply(this, arguments), this._setupRoutes(), this.set("_current", o(window.location.hash)), t.push(this), this.triggerOnStart && (this.defaultPathOnStart ? this.trigger({
                    change: !0,
        ...
        _execHandler: function (t, n, i, o) {
            var r = n,
                s = "string" == typeof t ? e.getPath.call(this, t) : t || this;
            return "string" == typeof n && (r = this[n] || s[n], "function" == typeof r && (o.handler = r, o.context = s)), r && "function" == typeof r ? (r.apply(s, i), !0) : !1
        },
        ...
        _handleDynamic: function (e) {
            for (var t, n, i, o, r, s = this._dynamicRoutes, a = 0, c = s.length; c > a; ++a)
                if (n = s[a], t = n.regex, r = t.exec(e)) return r = r.slice(1), i = n.handler, o = n.context, this._execHandler(o, i, r, n);
            return !1
        },
        _handleDefault: function (e) {
            var t = this.defaultRoute || {}, n = t.context,
                i = t.handler;
...
enyo.kind({
    ...
    viewChanged: function (e) {
        if (!e || (e.set("bubbleTarget", null), e.owner !== this || e.destroyed || e.destroy(), !e.destroyed || this.resetView)) {
            var t = this.view;
            if ("string" == typeof t && (t = enyo.getPath(t)), "function" == typeof t && (this.viewKind = t, t = null), "string" == typeof this.viewKind && (this.viewKind = enyo.getPath(this.viewKind)), !t && this.viewKind || t && "object" == typeof t && !(t instanceof enyo.UiComponent)) {
            ...
            } else t && t instanceof enyo.UiComponent && (this.viewKind || (this.viewKind = t.ctor), t.set("bubbleTarget", this));
            this.view = t
        }
    },
    create: enyo.inherit(function (e) {
...
enyo.applications = {}, enyo.kind({
    ...
    constructor: enyo.inherit(function (e) {
        return function (t) {
            t && "string" == typeof t.name && (enyo.setPath(t.name, this), this.id = t && t.name), e.apply(this, arguments), this.controllers = this.$, enyo.applications[this.id || this.makeId()] = this
        }
    }),
    create: enyo.inherit(function (e) {
        return function () {
    ...
    addObserver: enyo.inherit(function (e) {
        return function (t) {
            var n = arguments;
            return /^controllers/.test(t) && (this.warn("the `controllers` property is deprecated, please update bindings to instead use `$` instead (for path `" + t + "`)"), t = t.replace(/^controllers/, "$"), n = enyo.cloneArray(arguments), n[0] = t), e.apply(this, n)
        }
    }),
    owner: enyo.master,
    statics: {
        concat: function (e, t) {
            t.controllers && (enyo.warn("enyo.Application: the `controllers` property has been deprecated, please use the `components` property and update any bindings referencing `controllers` to use `$` instead"), t.components = t.components ? t.components.concat(t.controllers) : t.controllers.slice(), delete t.controllers)
        }
    }
});
...
enyo.singleton({
    ...
    add: function (e, t, n) {
        t = t || 5, t = enyo.isString(t) ? this._magicWords[t] : t, n && (this.remove(n), this._namedJobs[n] = t), t >= this.priorityLevel ? e() : this._jobs[t - 1].push({
            fkt: e,
            name: n
        })
    },
    remove: function (e) {
        ...
        if (t)
            for (var n = t.length - 1; n >= 0; n--)
                if (t[n].name === e) return t.splice(n, 1)
    },
    ...
    _doJob: function () {
        for (var e, t = 9; t >= this.priorityLevel; t--)
            if (this._jobs[t].length) {
...
enyo.macroize = function (e, t, n) {
    var i, o, r = e,
        s = n || enyo.macroize.pattern,
        a = function (e, n) {
            return i = enyo.getPath.call(t, n), void 0 === i || null === i ? "{$" + n + "}" : (o = !0, i)
        }, c = 0;
    do
        if (o = !1, r = r.replace(s, a), ++c >= 20) throw "enyo.macroize: recursion too deep"; while (o);
    return r
...
enyo.kind({
    ...
    handle: function (e, t) {
        var n = t.shift();
        if (n)
            if (n instanceof enyo.Async) this.route(n, e);
            else {
    ...
    endTimer: function () {
        this.timeoutJob && (this.endTime = enyo.perfNow(), clearTimeout(this.timeoutJob), this.timeoutJob = null, this.latency = this.endTime - this.startTime)
    },
...
enyo.xhr = {
    request: function (e) {
        var t = this.getXMLHttpRequest(e),
            n = this.simplifyFileURL(enyo.path.rewrite(e.url)),
            i = e.method || "GET",
            o = !e.sync;
        if (e.username ? t.open(i, n, o, e.username, e.password) : t.open(i, n, o), enyo.mixin(t, e.xhrFields), e.callback && this.makeReadyStateHandler(t, e.callback), e.headers = e.headers || {}, "GET" !== i && enyo.platform.ios && 6 == enyo.platform.ios && null !== e.headers["cache-control"] && (e.headers["cache-control"] = e.headers["cache-control"] || "no-cache"), t.setRequestHeader)
            for (var r in e.headers) e.headers[r] && t.setRequestHeader(r, e.headers[r]);
        return "function" == typeof t.overrideMimeType && e.mimeType && t.overrideMimeType(e.mimeType), t.send(e.body || null), !o && e.callback && t.onreadystatechange(t), t
    },
    cancel: function (e) {
    ...
    makeReadyStateHandler: function (e, t) {
        window.XDomainRequest && e instanceof window.XDomainRequest ? e.onload = function () {
            var n;
            "arraybuffer" === e.responseType ? n = e.response : "string" == typeof e.responseText && (n = e.responseText), t.apply(null, [n, e]), e = null
    ...
    inOrigin: function (e) {
        var t = document.createElement("a"),
            n = !1;
        return t.href = e, (":" === t.protocol || t.protocol === window.location.protocol && t.hostname === window.location.hostname && t.port === (window.location.port || ("https:" === window.location.protocol ? "443" : "80"))) && (n = !0), n
    },
    ...
    getXMLHttpRequest: function (e) {
        ...
        try {
            if (enyo.platform.firefoxOS) {
				return new XMLHttpRequest({ "mozSystem": true, "mozAnon": true });
			}
			else {
...
(function (e) {
    ...
    if (e.FormData) try {
        return new e.FormData, new e.Blob, enyo.FormData = e.FormData, enyo.Blob = e.Blob, void 0
    } catch (i) {}
...
enyo.kind({
    ...
    request: function (e) {
        var t = this.url.split("?"),
            n = t.shift() || "",
            i = t.length ? t.join("?").split("&") : [],
            o = null;
        enyo.isString(e) ? o = e : e && (o = enyo.Ajax.objectToQuery(e)), o && (i.push(o), o = null), this.cacheBust && i.push(Math.random());
        var r, s = i.length ? [n, i.join("&")].join("?") : n,
            a = {};
        "GET" != this.method && (r = this.postBody, "POST" === this.method && r instanceof enyo.FormData ? r.fake && (a["Content-Type"] = r.getContentType(), r = "" + r) : (a["Content-Type"] = this.contentType, r instanceof Object && (r = null !== this.contentType.match(/^application\/json(;.*)?$/) ? JSON.stringify(r) : "application/x-www-form-urlencoded" === this.contentType ? enyo.Ajax.objectToQuery(r) : "" + r))), enyo.mixin(a, this.headers), 0 === enyo.keys(a).length && (a = void 0);
        try {
        ...
        objectToQuery: function (e) {
            ...
            for (var o in e) {
                ...
                if (r != i[o]) {
                    var s = t(o) + "=";
                    if (enyo.isArray(r))
                        for (var a = 0; r.length > a; a++) n.push(s + t(r[a]));
                    else n.push(s + t(r))
                }
            }
            return n.join("&")
        ...
        parseResponseHeaders: function (e) {
            ...
            for (var i = 0; n.length > i; i++) {
                var o = n[i],
                    r = o.indexOf(": ");
                if (r > 0) {
                    var s = o.substring(0, r).toLowerCase(),
                        a = o.substring(r + 2);
                    t[s] = a
                }
            }
...
enyo.kind({
    ...
    addScriptElement: function () {
        ...
        e.src = this.src, e.async = "async", this.charset && (e.charset = this.charset), e.onerror = this.bindSafely(function () {
            this.fail(400)
        });
    ...
    buildUrl: function (e, t) {
        var n = this.url.split("?"),
            i = n.shift() || "",
            o = n.length ? n.join("?").split("&") : [],
            r = this.bodyArgsFromParams(e, t);
...
(function (e) {
    var t = function (e) {
        ...
        i = function () {
            ...
            return e += "//" + location.host, t.length > 1 && t[t.length - 1].match(/\./) && t.pop(), e += "/" + t.join("/")
        };
    e.kind({
        name: "enyo.XHRSource",
        kind: e.Source,
        ...
        go: function (t) {
            var n = this.requestKind,
                i = e.only(this._requestOptions, t),
                o = new n(i);
        ...
        commit: function (e, t) {
            t.method = e.isNew ? "POST" : "PUT", t.url = this.buildUrl(e, t), t.postBody = e.toJSON(), this.go(t)
        },
        ...
        commit: function (e, t) {
            t.cacheBust = !1, t.method = e.isNew ? "POST" : "PUT", t.url = this.buildUrl(e, t), t.postBody = e.toJSON(), this.go(t)
        },
        destroy: function (e, t) {
...
(function (e) {
    e.kind({
        ...
        addRecord: function (e) {
            var t = this.records,
                n = e.primaryKey,
                i = t.pk[e.kindName] || (t.pk[e.kindName] = {}),
                o = e.get(n),
                r = e.euid;
            ...
            t.kn[e.kindName] = t.kn[e.kindName] || (t.kn[e.kindName] = {}), t.kn[e.kindName][r] = e, e.store || (e.store = this)
        },
        addCollection: function (e) {
            var t = this.collections,
                n = e.euid;
            e.store && e.store !== this && e.store.removeCollection(e), e.addListener("destroy", this._collectionDestroyed), t[n] = e, e.store || (e.store = this)
        },
        ...
        find: function (t, n) {
            ...
            var i = e.isString(t) ? e.constructorForKind(t) : t,
                o = i.prototype,
                r = n,
                s = r.attributes,
                a = this.sources,
                c = this.records,
                u = o.primaryKey,
                h = r.source && (e.isString(r.source) && a[r.source] || r.source) || a[o.defaultSource],
                l = r.euid && c.euid[r.euid] || s && s[u] && c.pk[o.kindName][s[u]];
            return l ? r.success(r, l) : h ? (r = e.clone(r), r.success = this.bindSafely("didFind", n), r.fail = this.bindSafely("didFail", "find", n), n.strategy = n.strategy || "merge", h.find(i, r), void 0) : this.warn("could not find source `" + (r.source || o.defaultSource) + "`")
        },
        findLocal: function (t, n, i) {
            3 > arguments.length && e.isObject(t) && (e.isFunction(n) && (i = n), n = t, t = e.Model);
            var o, r = ("string" == typeof t ? e.constructorForKind(t) : t).prototype,
                s = this.records,
                a = r ? r.primaryKey : "",
                c = n[a];
            return n.euid ? s.euid[n.euid] : void 0 !== c && null !== c ? (o = s.pk[r.kindName], o && o[c] || void 0) : n.kindName ? (o = s.kn[n.kindName], o && e.values(o) || []) : (i = i && ("string" == typeof i && this[i] || i) || this.filter, i = this.bindSafely(i, n), e.filter(e.values(s.kn[r.kindName]) || [], i, this))
        },
        filter: function (e, t) {
            for (var n in e)
                if (t.get(n) !== e[n]) return !1;
            return !0
        },
        didFind: function () {
            this.log(arguments)
        ...
        fetchRecord: function (t, n) {
            var i = this.sources,
                o = n ? e.clone(n) : {}, r = i[o.source || t.defaultSource];
            if (!r) throw "enyo.Store: Could not find source '" + (o.source || t.defaultSource) + "'";
            o.success = this.bindSafely("didFetch", t, n), o.fail = this.bindSafely("didFail", "fetch", t, n), r.fetch(t, o)
        },
        commitRecord: function (t, n) {
            var i = this.sources,
                o = n ? e.clone(n) : {}, r = i[o.source || t.defaultSource];
            if (!r) throw "enyo.Store: Could not find source '" + (o.source || t.defaultSource) + "'";
            o.success = this.bindSafely("didCommit", t, n), o.fail = this.bindSafely("didFail", "commit", t, n), r.commit(t, o)
        },
        destroyRecord: function (t, n) {
            var i = this.sources,
                o = n ? e.clone(n) : {}, r = i[o.source || t.defaultSource];
            if (!r) throw "enyo.Store: Could not find source '" + (o.source || t.defaultSource) + "'";
            o.success = this.bindSafely("didDestroy", t, n), o.fail = this.bindSafely("didFail", "destroy", t, n), r.destroy(t, o)
        },
        ...
        constructor: e.inherit(function (e) {
            return function () {
                ...
                return this.sources = this.sources || {}, this.records = this.records || {}, this.collections = this.collections || {}, this._initRecords(), this._initSources(), this._recordDestroyed = this.bindSafely("_recordDestroyed"), this._collectionDestroyed = this.bindSafely("_collectionDestroyed"), t
            }
        })
    ...
    e.kind({
            ...
            if (this.attributes) {
                ...
                if (i || s !== n) {
                    if (this.previous[t] = s, this.computedMap && (r = this.computedMap[t])) {
                        ...
                        for (var a, c = 0; a = r[c]; ++c) this.attributes[t] = s, this.previous[a] = o[a] = this.get(a), this.attributes[t] = n, this.changed[a] = this.get(a), this._updated = !0
                    }
                    if (this.changed[t] = this.attributes[t] = n, this.notifyObservers(t, s, n), this._updated = !0, o)
                        for (var u in o) this.notifyObservers(u, this.previous[u], o[u]);
                    !this.isSilenced() && this._updated && (this._updated = !1, this.triggerEvent("change"), this.changed = {}), this.dirty = !0
                }
            }
            return this
        },
        setObject: function (e) {
            if (this.attributes && e) {
                ...
                this.startNotifications(), this.unsilence(), t && (this._updated = !1, this.triggerEvent("change")), this.changed = {}
            }
            return this
        },
        constructor: function (n, i) {
            i && this.importProps(i), this.euid = e.uuid();
            var o = this.attributes = this.attributes ? e.clone(this.attributes) : {}, r = this.defaults,
                s = n;
            s && e.mixin(o, this.parse(s)), r && e.mixin(o, r, t), this.changed = {}, this.previous = this.raw(), this.storeChanged()
        },
        ...
        getUrl: function () {
            var e = this.primaryKey,
                t = this.get(e),
                n = this.urlRoot + "/" + this.url;
            return t && (n += "/" + t), n
        },
        commit: function (t) {
            var n = t ? e.clone(t) : {};
            n.success = e.bindSafely(this, "didCommit", this, t), n.fail = e.bindSafely(this, "didFail", "commit", this, t), this.store.commitRecord(this, n)
        },
        fetch: function (t) {
            var n = t ? e.clone(t) : {};
            n.success = e.bindSafely(this, "didFetch", this, t), n.fail = e.bindSafely(this, "didFail", "fetch", this, t), this.store.fetchRecord(this, n)
        },
        destroy: function (t) {
            if (this.readOnly || this.isNew) return this.destroyLocal();
            var n = t ? e.clone(t) : {};
            n.success = e.bindSafely(this, "didDestroy", this, t), n.fail = e.bindSafely(this, "didFail", "destroy", this, t), this.store.destroyRecord(this, n)
        },
        ...
        didDestroy: function (t, n, i) {
            ...
            this.triggerEvent("destroy"), this.store._recordDestroyed(this), this.previous = null, this.changed = null, this.defaults = null, this.includeKeys = null, this.mergeKeys = null, this.store = null, this.destroyed = !0, this.removeAllObservers(), this.removeAllListeners(), n && n.success && n.success(t, n, i)
        },
        didFail: function (e, t, n, i) {
        ...
        storeChanged: function () {
            ...
            t && e.isString(t) && (t = e.getPath(t), t || e.warn("enyo.Model: could not find the requested store -> ", this.store, ", usingthe default store")), t = this.store = t || e.store, t.addRecord(this)
        },
        ...
        var i = t.prototype || t;
        n.attributes && (i.attributes = i.attributes ? e.mixin(e.clone(i.attributes), n.attributes) : n.attributes, delete n.attributes), n.defaults && (i.defaults = i.defaults ? e.mixin(e.clone(i.defaults), n.defaults) : n.defaults, delete n.defaults), n.mergeKeys && (i.mergeKeys = i.mergeKeys ? e.merge(i.mergeKeys, n.mergeKeys) : n.mergeKeys.slice(), delete n.mergeKeys)
    }
})(enyo);
...
enyo.kind({
    ...
    fetch: function (e) {
        ...
        (e = e || {}) && (e.strategy = e.strategy || "add"), t.success = enyo.bindSafely(this, "didFetch", this, e), t.fail = enyo.bindSafely(this, "didFail", "fetch", this, e), this.set("isFetching", !0), enyo.asyncMethod(this, function () {
    ...
    merge: function (e) {
        if (e) {
            var t = this.model.prototype,
                n = t.primaryKey,
                i = t.mergeKeys,
                o = [],
                r = this.records.slice(),
                s = !1,
                a = !1;
            ...
            for (var c, u = 0; c = e[u]; ++u) {
                ...
                if (i || null !== h && void 0 !== h) {
                    for (var l, d = 0; !s && (l = r[d]); ++d)
                        if (null !== h && void 0 !== h && h === (l.get ? l.get(n) : l[n])) s = !0, r.splice(d, 1);
                        else if (i) {
                        a = !1;
    ...
    add: function (e, t) {
        ...
        var n = this.records,
            i = [],
            o = this.length;
        if (t = null === t || isNaN(t) ? o : Math.max(0, Math.min(o, t)), e = enyo.isArray(e) ? e : [e], !e.length) return i;
        ...
        return e.unshift.apply(e, [t, 0]), n.splice.apply(n, e), e.splice(0, 2), this.length = n.length, o !== this.length && this.notifyObservers("length", o, this.length), i.length && this.triggerEvent("add", {
            records: i
        }), i
    },
    remove: function (e) {
        ...
        var t, n, i = [],
            o = {}, r = this.length;
        e = enyo.isArray(e) && e || [e];
        for (var s, a, c, u = 0; s = e[u]; ++u)
            if ((a = this.indexOf(s)) > -1) {
                if (void 0 === n || n >= a) n = a, i.unshift(a);
                else if (void 0 === t || a >= t) t = a, i.push(a);
                else if (t !== a && n !== a) {
                    for (c = 0; a > i[c];)++c;
                    i.splice(c, 0, a)
                }
        ...
        for (u = i.length - 1; !isNaN(a = i[u]); --u) this.records.splice(a, 1), o[a] instanceof this.model && (o[a].removeListener("change", this._recordChanged), o[a].removeListener("destroy", this._recordDestroyed));
        return this.length = this.records.length, r != this.length && this.notifyObservers("length", r, this.length), i.length && this.triggerEvent("remove", {
            records: o
        }), o
    },
    reset: function (e) {
        ...
        if (!e && this.filtered) {
            ...
            t = this.records.length, this._uRecords = this.records, this._uRecords = null, this.records = i, this.length = this.records.length, this.filtered = !1, n = !0
        } else e && enyo.isArray(e) && (this.filtering && (this.filtered || (this._uRecords = this.records.slice())), t = this.records.length, this.records = e.slice(), this.length = this.records.length, n = !0);
        return n && (t !== this.length && this.notifyObservers("length", t, this.length), this.triggerEvent("reset", {
    ...
    at: function (e) {
        ...
        return !t || t instanceof this.model || (t = this.records[e] = this.createRecord(t, null, !1)), t
    },
    createRecord: function (e, t, n) {
        var i, o = {
                owner: this
            };
        return e && e.isNew === !1 && ((t || o).isNew = !1, delete e.isNew), i = this.store.createRecord(this.model, e, t ? enyo.mixin(o, t) : o), n = !1 === n ? -1 : null !== n && n >= 0 ? n : this.length, i.addListener("change", this._recordChanged), i.addListener("destroy", this._recordDestroyed), n >= 0 && this.add(i, n), i
    },
    recordChanged: null,
    constructor: enyo.inherit(function (e) {
        return function (t, n) {
            var i = enyo.isArray(t) ? t.slice() : null,
                o = n || (t && !i ? t : null);
            o && this.importProps(o), this.records = (this.records || []).concat(i ? this.parse(i) : []), this.length = this.records.length, this._recordChanged = enyo.bindSafely(this, this._recordChanged), this._recordDestroyed = enyo.bindSafely(this, this._recordDestroyed), this.euid = enyo.uuid();
            var r = this.model;
            if (this.model = r && enyo.isString(r) ? enyo.getPath(r) : enyo.checkConstructor(r), this.storeChanged(), this.filters = this.filters || {}, this.filterProps.length)
                for (var s, a = enyo.bindSafely(this, function () {
                        this.triggerEvent("filter")
                    }), c = 0, u = this.filterProps.split(" "); s = u[c]; ++c) this.addObserver(s, a);
            this.addListener("filter", this._filterContent, this), this.addObserver("activeFilter", this._activeFilterChanged, this), t = n = void 0, e.apply(this, arguments)
        }
    }),
    destroy: enyo.inherit(function (e) {
        return function () {
    ...
    importProps: function (e) {
        e && (e.records && (this.records = this.records ? this.records.concat(e.records) : e.records, delete e.records), enyo.kind.statics.extend(e, this))
    },
    storeChanged: function () {
        var e = this.store || enyo.store;
        e && enyo.isString(e) && (e = enyo.getPath(e), e || enyo.warn("enyo.Collection: could not find the requested store -> ", this.store, ", usingthe default store")), e = this.store = e || enyo.store, e.addCollection(this)
    },
    _activeFilterChanged: function () {
        var e = this.activeFilter,
            t = this.filters;
    ...
    var n = e.prototype || e;
    t.filters && n.filters && (n.filters = enyo.mixin(enyo.clone(n.filters), t.filters), delete t.filters), t.filterProps && (enyo.isArray(t.filterProps) && (t.filterProps = t.filterProps.join(" ")), n.filterProps && (n.filterProps += " " + t.filterProps, delete t.filterProps))
};
...
enyo.kind({
    ...
    sync: function (e) {
        var t = this.model,
            n = e || this.model && this.model.attributes;
        for (var i in n) this.notifyObservers(i, t ? t.previous[i] : n[i], t ? this.model.get(i) : null)
    },
    modelChanged: function (e, t) {
        var n = e,
            i = t;
        n && (n.removeListener("change", this._modelChanged), n.removeListener("destroy", this._modelDestroyed), i || this.sync(n.attributes)), i && (i.addListener("change", this._modelChanged), i.addListener("destroy", this._modelDestroyed), this.sync())
    },
    create: enyo.inherit(function (e) {
        return function () {
...
enyo.requiresWindow = function (e) {
    ...
    _ie8GetComputedStyle: function (e) {
        var t = /(\-([a-z]){1})/g;
        return "float" === e ? e = "styleFloat" : t.test(e) && (e = e.replace(t, function () {
            return arguments[2].toUpperCase()
        })), void 0 !== this[e] ? this[e] : null
    },
    getComputedStyle: function (e) {
        if (9 > enyo.platform.ie && e && e.currentStyle) {
            var t = enyo.clone(e.currentStyle);
            return t.getPropertyValue = this._ie8GetComputedStyle, t.setProperty = function () {
                return e.currentStyle.setExpression.apply(e.currentStyle, arguments)
            }, t.removeProperty = function () {
                return e.currentStyle.removeAttribute.apply(e.currentStyle, arguments)
            }, t
        }
        return window.getComputedStyle && e && window.getComputedStyle(e, null)
    },
    getComputedStyleValue: function (e, t, n) {
        var i = n || this.getComputedStyle(e),
            o = enyo.platform.ie;
        if (i = i ? i.getPropertyValue(t) : null, o) {
            var r = {
                thin: (o > 8 ? 2 : 1) + "px",
                medium: (o > 8 ? 4 : 3) + "px",
                thick: (o > 8 ? 6 : 5) + "px",
            ...
            if (r[i] !== void 0 && (i = r[i]), "auto" == i) switch (t) {
            case "width":
                i = e.offsetWidth;
                break;
            case "height":
    ...
    applyBodyFit: function () {
        ...
        e && this.addClass(e, "enyo-document-fit"), enyo.dom.addBodyClass("enyo-body-fit"), enyo.bodyIsFitting = !0
    },
    getWindowWidth: function () {
        return window.innerWidth ? window.innerWidth : document.body && document.body.offsetWidth ? document.body.offsetWidth : "CSS1Compat" == document.compatMode && document.documentElement && document.documentElement.offsetWidth ? document.documentElement.offsetWidth : 320
    },
    getWindowHeight: function () {
        return window.innerHeight ? window.innerHeight : document.body && document.body.offsetHeight ? document.body.offsetHeight : "CSS1Compat" == document.compatMode && document.documentElement && document.documentElement.offsetHeight ? document.documentElement.offsetHeight : 480
    },
    compareDocumentPosition: function (e, t) {
        return e.compareDocumentPosition ? e.compareDocumentPosition(t) : e.contains ? (e != t && e.contains(t) && 16) + (e != t && t.contains(e) && 8) + (e.sourceIndex >= 0 && t.sourceIndex >= 0 ? (e.sourceIndex < t.sourceIndex && 4) + (e.sourceIndex > t.sourceIndex && 2) : 1) + 0 : 0
    },
    _ieCssToPixelValue: function (e, t) {
        ...
        return r && (e.runtimeStyle.left = e.currentStyle.left), i.left = n, n = i.pixelLeft, i.left = o, r && (i.runtimeStyle.left = r), n
    },
    _pxMatch: /px/i,
    getComputedBoxValue: function (e, t, n, i) {
        var o = i || this.getComputedStyle(e);
        if (o && (!enyo.platform.ie || enyo.platform.ie >= 9)) {
            var r = o.getPropertyValue(t + "-" + n);
            return "auto" === r ? 0 : parseInt(r, 10)
        }
        if (e && e.currentStyle) {
    ...
    calcNodePosition: function (e, t) {
        var n = 0,
            ...
            r = o.offsetWidth,
            s = o.offsetHeight,
            a = enyo.dom.getStyleTransformProp(),
            c = /translateX\((-?\d+)px\)/i,
            u = /translateY\((-?\d+)px\)/i,
            h = 0,
            l = 0,
            ...
            y = 0,
            p = 0;
        if (t ? (d = t.offsetHeight, f = t.offsetWidth) : (d = document.body.parentNode.offsetHeight > this.getWindowHeight() ? this.getWindowHeight() - document.body.parentNode.scrollTop : document.body.parentNode.offsetHeight, f = document.body.parentNode.offsetWidth > this.getWindowWidth() ? this.getWindowWidth() - document.body.parentNode.scrollLeft : document.body.parentNode.offsetWidth), o.offsetParent)
            do t && 8 & this.compareDocumentPosition(t, o.offsetParent) && (y = t.offsetLeft, p = t.offsetTop), i += o.offsetLeft - (o.offsetParent ? o.offsetParent.scrollLeft : 0) - y, a && c.test(o.style[a]) && (i += parseInt(o.style[a].replace(c, "$1"), 10)), n += o.offsetTop - (o.offsetParent ? o.offsetParent.scrollTop : 0) - p, a && u.test(o.style[a]) && (n += parseInt(o.style[a].replace(u, "$1"), 10)), o !== e && (o.currentStyle ? (h = parseInt(o.currentStyle.borderLeftWidth, 10), l = parseInt(o.currentStyle.borderTopWidth, 10)) : window.getComputedStyle ? (h = parseInt(window.getComputedStyle(o, "").getPropertyValue("border-left-width"), 10), l = parseInt(window.getComputedStyle(o, "").getPropertyValue("border-top-width"), 10)) : (h = parseInt(o.style.borderLeftWidth, 10), l = parseInt(o.style.borderTopWidth, 10)), h && (i += h), l && (n += l)); while ((o = o.offsetParent) && (!t || 16 & this.compareDocumentPosition(t, o)));
        return {
            top: n,
            left: i,
            bottom: d - n - s,
    ...
    hasClass: function (e, t) {
        return e && e.className ? (" " + e.className + " ").indexOf(" " + t + " ") >= 0 : void 0
    },
    ...
    removeClass: function (e, t) {
        if (e && this.hasClass(e, t)) {
            var n = e.className;
            e.className = (" " + n + " ").replace(" " + t + " ", " ").slice(1, -1)
        }
    },
    addBodyClass: function (e) {
        enyo.exists(enyo.roots) ? enyo.dom.addClass(document.body, e) : enyo.dom._bodyClasses ? enyo.dom._bodyClasses.push(e) : enyo.dom._bodyClasses = [e]
    },
    getAbsoluteBounds: function (e) {
        for (var t = e, n = 0, i = 0, o = t.offsetWidth, r = t.offsetHeight, s = enyo.dom.getStyleTransformProp(), a = /translateX\((-?\d+)px\)/i, c = /translateY\((-?\d+)px\)/i, u = /(?!matrix3d\()(-?\d+|-?\d+\.\d+)(?=[,\)])/g, h = null, l = null, d = null; t;) t.offsetParent != d && (enyo.platform.firefox ? (n += t.offsetLeft, i += t.offsetTop) : (n += t.offsetLeft - (t.offsetParent ? t.offsetParent.scrollLeft : 0), i += t.offsetTop - (t.offsetParent ? t.offsetParent.scrollTop : 0)), d = t.offsetParent), s && t.style && (l = t.style[s], h = l.match(a), h && h[1] !== void 0 && h[1] && (n += parseInt(h[1], 10)), h = l.match(c), h && h[1] !== void 0 && h[1] && (i += parseInt(h[1], 10)), h = l.match(u), h && 16 === h.length && (h[12] !== void 0 && "0" !== h[12] && (n += parseFloat(h[12])), h[13] !== void 0 && "0" !== h[13] && (i += parseFloat(h[13])))), t = t.parentNode;
        return {
            top: e ? i : void 0,
            left: e ? n : void 0,
            bottom: e ? document.body.offsetHeight - i - r : void 0,
            right: e ? document.body.offsetWidth - n - o : void 0,
            height: r,
            width: o
        }
    },
    flushBodyClasses: function () {
        if (enyo.dom._bodyClasses) {
            for (var e, t = 0; e = enyo.dom._bodyClasses[t]; ++t) enyo.dom.addClass(document.body, e);
            enyo.dom._bodyClasses = null
        }
    },
    _bodyClasses: null
}, window.MSApp !== void 0 && (enyo.dom.setInnerHtml = function (e, t) {
    window.MSApp.execUnsafeLocalFunction(function () {
        e.innerHTML = t
    })
}), document.head && document.head.classList && (enyo.dom.hasClass = function (e, t) {
    return e ? e.classList.contains(t) : void 0
}, enyo.dom.addClass = function (e, t) {
    return e ? e.classList.add(t) : void 0
}, enyo.dom.removeClass = function (e, t) {
    return e ? e.classList.remove(t) : void 0
});

// ..\source\dom\transform.js
(function () {
    enyo.dom.calcCanAccelerate = function () {
        if (2 >= enyo.platform.android) return !1;
        for (var e, t = ["perspective", "WebkitPerspective", "MozPerspective", "msPerspective", "OPerspective"], n = 0; e = t[n]; n++)
            if (document.body.style[e] !== void 0) return !0;
        return !1
    };
    ...
    enyo.dom.getCssTransformProp = function () {
        ...
        for (var e, n = 0; e = t[n]; n++)
            if (document.body.style[e] !== void 0) return this._styleTransformProp = e, this._styleTransformProp
        ...
        var t = this.domTransformsToCss(e.domTransforms),
            n = e.hasNode() ? e.node.style : null,
            i = e.domStyles,
            o = this.getStyleTransformProp(),
            r = this.getCssTransformProp();
...
enyo.kind({
    ...
    create: enyo.inherit(function (e) {
        return function () {
            null == this.tag && (this._needsRender = !1), this.initStyles(), e.apply(this, arguments), this.showingChanged(), this.kindClasses && this.addClass(this.kindClasses), this.classes && this.addClass(this.classes), this.initProps(["id", "content", "src"])
        }
    }),
    constructor: enyo.inherit(function (e) {
        return function () {
    ...
    destroy: enyo.inherit(function (e) {
        return function () {
            this.removeFromRoots(), this.removeNodeFromDom(), enyo.Control.unregisterDomEvents(this.id), e.apply(this, arguments)
        }
    }),
    ...
    initStyles: function () {
        this.domStyles = this.domStyles ? enyo.clone(this.domStyles) : {}, enyo.Control.cssTextToDomStyles(this.kindStyle + this.style, this.domStyles), "none" == this.domStyles.display && (this.showing = !1, this.domStyles.display = "")
    },
    styleChanged: function () {
        this.domStyles = {}, enyo.Control.cssTextToDomStyles(this.kindStyle + this.style, this.domStyles), this.domStylesChanged()
    },
    ...
    addStyles: function (e) {
        if (enyo.isObject(e))
            for (var t in e) this.domStyles[t] = e[t];
        else enyo.Control.cssTextToDomStyles(e, this.domStyles);
    ...
    renderInto: function (e) {
        ...
        var t = enyo.dom.byId(e),
            n = enyo.exists(this.fit) && this.fit === !1;
        return t != document.body || n ? this.fit && this.addClass("enyo-fit enyo-clip") : this.setupBodyFitting(), this.addClass("enyo-no-touch-action"), this.setupOverflowScrolling(), enyo.dom._bodyClasses && enyo.dom.flushBodyClasses(), enyo.dom.setInnerHtml(t, this.generateHtml()), enyo.addToRoots(this), this.generated && this.rendered(), this
    },
    write: function () {
        return enyo.dom._bodyClasses && enyo.dom.flushBodyClasses(), this.fit && this.setupBodyFitting(), this.addClass("enyo-no-touch-action"), this.setupOverflowScrolling(), document.write(this.generateHtml()), enyo.addToRoots(this), this.generated && this.rendered(), this
    },
    rendered: function () {
        this.reflow();
    ...
    setBounds: function (e, t) {
        for (var n, i, o = this.domStyles, r = t || "px", s = ["width", "height", "left", "top", "right", "bottom"], a = 0; i = s[a]; a++) n = e[i], (n || 0 === n) && (o[i] = n + (enyo.isString(n) ? "" : r));
        this.domStylesChanged()
    },
    getAbsoluteBounds: function () {
        var e = this.node || this.hasNode(),
            t = enyo.dom.getAbsoluteBounds(e);
        return t || {
            left: void 0,
            top: void 0,
            width: void 0,
    ...
    generateHtml: function () {
        ...
        var e = this.generateInnerHtml(),
            t = this.generateOuterHtml(e);
        return this.generated = !0, this._needsRender = !1, t
    },
    ...
    getDomCssText: function () {
        return this.stylesValid || (this.domCssText = enyo.Control.domStylesToCssText(this.domStyles), this.stylesValid = !0), this.domCssText
    },
    ...
    renderReusingNode: function () {
        if (this.canGenerate)
            if (null === this.tag || this.generated)
                if (this.children.length)
                    for (var e, t = 0; e = this.children[t]; ++t) e.renderReusingNode();
                else this.generated && this.hasNode() && this._needsRender && (enyo.dom.setInnerHtml(this.node, this.generateInnerHtml()), this._needsRender = !1);
                else this.render()
    },
    ...
    syncDisplayToShowing: function () {
        ...
        this.showing ? "none" == e.display && this.applyStyle("display", this._displayStyle || "") : (this._displayStyle = "none" == e.display ? "" : e.display, this.applyStyle("display", "none"))
    },
    ...
    getAbsoluteShowing: function (e) {
        var t;
        return e || (t = this.getBounds()), this.getShowing() === !1 || t && 0 === t.height && 0 === t.width ? !1 : this.parent && this.parent.getAbsoluteShowing ? this.parent.getAbsoluteShowing(e) : !0
    },
    ...
    statics: {
        ...
        cssTextToDomStyles: function (e, t, n) {
            if (e)
                for (var i, o, r, s, a = e.replace(/;$/, "").split(/\s*;[\s;]*/), c = 0; s = a[c]; c++) i = s.split(/\s*:\s*/), o = i.shift(), n ? delete t[o] : (r = i.join(":"), t[o] = r)
        },
    ...
    var i = e.prototype || e;
    t.classes && (n ? i.classes = enyo.trim((i.classes ? i.classes + " " : "") + t.classes) : (i.kindClasses = enyo.trim((i.kindClasses ? i.kindClasses : "") + (i.classes ? " " + i.classes : "")), i.classes = t.classes), delete t.classes), t.style && (n ? i.style = enyo.Control.normalizeCssStyleString((i.style ? i.style + ";" : "") + (" " + (t.style + ";"))) : (i.kindStyle = enyo.Control.normalizeCssStyleString((i.kindStyle ? i.kindStyle + "; " : "") + (i.style ? " " + i.style : "")), i.style = enyo.Control.normalizeCssStyleString(t.style)), delete t.style), t.attributes && (i.attributes = i.attributes ? enyo.mixin(enyo.clone(i.attributes), t.attributes) : t.attributes, delete t.attributes)
...
function () {
    for (var e, t, n, i = navigator.userAgent, o = enyo.platform, r = [{
        ...
        if (t = e.regex.exec(i)) {
            n = e.forceVersion ? e.forceVersion : Number(t[1]), o[e.platform] = n, e.extra && enyo.mixin(o, e.extra), o.platformName = e.platform;
            break
        }
...
(function () {
    for (var e, t, n, i = Math.round(1e3 / 60), o = ["webkit", "moz", "ms", "o", ""], r = "requestAnimationFrame", s = "cancel" + enyo.cap(r), a = function (e) {
        ...
        ((e = o[u]) || h > u) && !(enyo.platform.ios >= 6); u++)
        if (t = e ? e + enyo.cap(s) : s, n = e ? e + enyo.cap(r) : r, window[t]) {
...
enyo.ready(function () {
    function e(e) {
        e = e || window.event, enyo.hidden = e.type in i ? i[e.type] : document[t], enyo.visibilityState = e.type in i ? i[e.type] ? "hidden" : "visible" : document[n], enyo.Signals.send("onvisibilitychange", enyo.mixin(e, {
            hidden: enyo.hidden
        }))
    }
    var t = "hidden",
        n = "visibilityState",
        i = {};
    i.blur = i.focusout = i.pagehide = !0, i.focus = i.focusin = i.pageshow = !1, t in document ? document.addEventListener("visibilitychange", e) : (t = "mozHidden") in document ? (document.addEventListener("mozvisibilitychange", e), n = "mozVisibilityState") : (t = "webkitHidden") in document ? (document.addEventListener("webkitvisibilitychange", e), n = "webkitVisibilityState") : (t = "msHidden") in document ? (document.addEventListener("msvisibilitychange", e), n = "msVisibilityState") : "onfocusin" in document ? document.onfocusin = document.onfocusout = e : window.onpageshow = window.onpagehide = window.onfocus = window.onblur = e, enyo.hidden = document[t] !== void 0 ? document[t] : !1, enyo.visibilityState = document[n] !== void 0 ? document[n] : "visible"
});
...
(function (e) {
    e.$ = {}, e.dispatcher = {
        ...
        listen: function (t, n, i) {
            ...
            this.listen = t.addEventListener ? function (e, t, n) {
                ...
                t.attachEvent("on" + n, function (t) {
                    return t.target = t.srcElement, t.preventDefault || (t.preventDefault = e.iePreventDefault), (i || o)(t)
                })
            }, this.listen(t, n, i)
        },
        ...
        dispatch: function (e) {
            ...
            e.dispatchTarget = t;
            for (var n, i = 0; n = this.features[i]; i++)
                if (n.call(this, e) === !0) return;
    ...
    }, e.bubbler = "enyo.bubble(arguments[0])",
    function () {
        var t = function () {
    ...
    e.dispatcher.features.push(function (e) {
        ("mousemove" == e.type || "tap" == e.type || "click" == e.type || "touchmove" == e.type) && (t.clientX = e.clientX, t.clientY = e.clientY, t.pageX = e.pageX, t.pageY = e.pageY, t.screenX = e.screenX, t.screenY = e.screenY)
    ...
    var e = "previewDomEvent",
        t = {
            ...
            dispatch: function (t, n) {
                for (var i, o = this.buildLineage(n), r = 0; i = o[r]; r++)
                    if (i[e] && i[e](t) === !0) return t.preventDispatch = !0, void 0
            },
...
enyo.dispatcher.features.push(function (e) {
    if (this.captureTarget) {
        var t = e.dispatchTarget,
            n = (e.customEvent ? "" : "on") + e.type,
            i = this.captureEvents[n],
            o = this.captureHandlerScope || this.captureTarget,
            r = i && o[i],
            s = r && !(t && t.isDescendantOf && t.isDescendantOf(this.captureTarget));
        if (s) {
    ...
    release: function (e) {
        for (var t = this.captures.length - 1; t >= 0; t--)
            if (this.captures[t].target === e) {
...
enyo.gesture = {
    ...
    makeEvent: function (e, t) {
        ...
        if (n.srcEvent = n.srcEvent || t, n.preventDefault = this.preventDefault, n.disablePrevention = this.disablePrevention, 10 > enyo.platform.ie) {
            8 == enyo.platform.ie && n.target && (n.pageX = n.clientX + n.target.scrollLeft, n.pageY = n.clientY + n.target.scrollTop);
    ...
    down: function (e) {
        ...
        t.configureHoldPulse = this.configureHoldPulse, enyo.dispatch(t), this.downEvent = t, this.drag.cancelHold(), this.drag.beginHold(t)
    },
    move: function (e) {
    ...
    up: function (e) {
        ...
        t.preventTap = function () {
            n = !0
        }, enyo.dispatch(t), !n && this.downEvent && 1 == this.downEvent.which && this.sendTap(t), this.downEvent = null
    },
    over: function (e) {
...
enyo.dispatcher.features.push(function (e) {
    ...
    move: function (e) {
        if (this.tracking) {
            if (this.track(e), !e.which) return this.stopDragging(e), this.cancelHold(), this.tracking = !1, void 0;
            this.dragEvent ? this.sendDrag(e) : "onMove" === this.holdPulseConfig.endHold && (this.dy * this.dy + this.dx * this.dx >= this.holdPulseConfig.moveTolerance ? this.holdJob && (this.holdPulseConfig.resume ? this.stopHold() : (this.cancelHold(), this.sendDragStart(e))) : this.holdPulseConfig.resume && !this.holdJob && this.beginHold(e))
        }
    },
    up: function (e) {
    ...
    leave: function (e) {
        this.dragEvent ? this.sendDragOut(e) : "onLeave" === this.holdPulseConfig.endHold && (this.holdPulseConfig.resume ? this.stopHold() : (this.cancelHold(), this.sendDragStart(e)))
    },
    ...
    makeDragEvent: function (e, t, n, i) {
        var o = Math.abs(this.dx),
            r = Math.abs(this.dy),
            s = o > r,
            a = .414 > (s ? r / o : o / r),
            c = {};
        return c.type = e, c.dx = this.dx, c.dy = this.dy, c.ddx = this.dx - this.lastDx, c.ddy = this.dy - this.lastDy, c.xDirection = this.xDirection, c.yDirection = this.yDirection, c.pageX = n.pageX, c.pageY = n.pageY, c.clientX = n.clientX, c.clientY = n.clientY, c.horizontal = s, c.vertical = !s, c.lockable = a, c.target = t, c.dragInfo = i, c.ctrlKey = n.ctrlKey, c.altKey = n.altKey, c.metaKey = n.metaKey, c.shiftKey = n.shiftKey, c.srcEvent = n.srcEvent, 8 == enyo.platform.ie && c.target && (c.pageX = c.clientX + c.target.scrollLeft, c.pageY = c.clientY + c.target.scrollTop), c.preventDefault = enyo.gesture.preventDefault, c.disablePrevention = enyo.gesture.disablePrevention, c
    },
    ...
    startTracking: function (e) {
        this.tracking = !0, this.px0 = e.clientX, this.py0 = e.clientY, this.flickInfo = {}, this.flickInfo.startEvent = e, this.flickInfo.moves = [], this.track(e)
    },
    track: function (e) {
    ...
    endTracking: function () {
        ...
        var e = this.flickInfo,
            t = e && e.moves;
        if (t && t.length > 1) {
            for (var n, i = t[t.length - 1], o = enyo.perfNow(), r = t.length - 2, s = 0, a = 0, c = 0, u = 0, h = 0, d = 0, l = 0; n = t[r]; r--) s = o - n.t, a = (i.x - n.x) / s, c = (i.y - n.y) / s, d = d || (0 > a ? -1 : a > 0 ? 1 : 0), l = l || (0 > c ? -1 : c > 0 ? 1 : 0), (a * d > u * d || c * l > h * l) && (u = a, h = c);
    ...
    beginHold: function (e) {
        ...
        var t = enyo.clone(e);
        t.srcEvent = enyo.clone(e.srcEvent), this._holdJobFunction = enyo.bind(this, "sendHoldPulse", t), this._holdJobFunction.ce = t, this.holdJob = setInterval(this._holdJobFunction, this.holdPulseConfig.delay)
    },
    cancelHold: function () {
        this.stopHold(), this.sentHold && (this.sentHold = !1, this.sendRelease(this.holdEvent))
    },
    stopHold: function () {
        clearInterval(this.holdJob), this.holdJob = null, this._holdJobFunction && (this._holdJobFunction.ce = null, this._holdJobFunction = null)
    },
...
enyo.requiresWindow(function () {
    ...
    var n = {
        ...
        touchmove: function (t) {
            ...
            e.move(i), enyo.bodyIsFitting && t.preventDefault(), this.overEvent && this.overEvent.target != i.target && (this.overEvent.relatedTarget = i.target, i.relatedTarget = this.overEvent.target, e.out(this.overEvent), e.over(i)), this.overEvent = i
        },
        touchend: function (t) {
        ...
        findTargetTraverse: function (e, t, n) {
            var i = e || document.body,
                o = this.calcNodeOffset(i);
            if (o && i != this.excludedTarget) {
                var r = t - o.left,
                    s = n - o.top;
                if (r > 0 && s > 0 && o.width >= r && o.height >= s) {
                    for (var a, c, u = i.childNodes, h = u.length - 1; c = u[h]; h--)
                        if (a = this.findTargetTraverse(c, t, n)) return a;
                    return i
                }
            }
        },
...
// ..\source\touch\msevents.js
(function () {
    var e;
    if (window.navigator.pointerEnabled ? e = ["pointerdown", "pointerup", "pointermove", "pointerover", "pointerout", "pointercancel"] : window.navigator.msPointerEnabled && (e = ["MSPointerDown", "MSPointerUp", "MSPointerMove", "MSPointerOver", "MSPointerOut", "MSPointerCancel"]), e) {
        var t = function (e) {
            var t = enyo.clone(e);
        ...
        !window.navigator.pointerEnabled && window.navigator.msPointerEnabled && (i.MSPointerDown = i.pointerdown, i.MSPointerUp = i.pointerup, i.MSPointerMove = i.pointermove, i.MSPointerCancel = i.pointercancel, i.MSPointerOver = i.pointerover, i.MSPointerOut = i.pointerout), enyo.forEach(e, function (e) {
    ...
    var e = {
        ...
        touchend: !0
            ...
            gesturePositions: function (e) {
                var t = this.findIdentifiedTouch(e.touches, this.orderedTouches[0]),
                    n = this.findIdentifiedTouch(e.touches, this.orderedTouches[this.orderedTouches.length - 1]),
                    i = t.pageX,
                    o = n.pageX,
                    r = t.pageY,
                    s = n.pageY,
            ...
            gestureAngle: function (e) {
                var t = e,
                    n = Math.asin(t.y / t.h) * (180 / Math.PI);
...
enyo.kind({
    ...
    friction: function (e, t, n) {
        var i = this[e] - this[t],
            o = Math.abs(i) > this.kFrictionEpsilon ? n : 0;
        this[e] = this[t] + o * i
    },
    frame: 10,
    simulate: function (e) {
        for (; e >= this.frame;) e -= this.frame, this.dragging || this.constrain(), this.verlet(), this.friction("y", "y0", this.kFrictionDamping), this.friction("x", "x0", this.kFrictionDamping);
        return e
    },
    animate: function () {
        this.stop();
        var e, t, n = enyo.perfNow(),
            i = 0,
            o = this.bindSafely(function () {
                var r = enyo.perfNow();
                this.job = enyo.requestAnimationFrame(o);
                var s = r - n;
                n = r, this.dragging && (this.y0 = this.y = this.uy, this.x0 = this.x = this.ux), i += Math.max(16, s), this.fixedTime && !this.isInOverScroll() && (i = this.interval), i = this.simulate(i), t != this.y || e != this.x ? this.scroll() : this.dragging || (this.stop(!0), this.scroll()), t = this.y, e = this.x
            });
        this.job = enyo.requestAnimationFrame(o)
    },
    start: function () {
    ...
    stabilize: function () {
        ...
        var e = Math.min(this.topBoundary, Math.max(this.bottomBoundary, this.y)),
            t = Math.min(this.leftBoundary, Math.max(this.rightBoundary, this.x));
    ...
    mousewheel: function (e) {
        ...
        return t > 0 && this.y < this.topBoundary || 0 > t && this.y > this.bottomBoundary ? (this.stop(!0), this.y = this.y0 = this.y0 + t, this.start(), !0) : void 0
    },
    scroll: function () {
        this.doScroll()
    },
    scrollTo: function (e, t) {
        null !== t && (this.y = this.y0 - (t + this.y0) * (1 - this.kFrictionDamping)), null !== e && (this.x = this.x0 - (e + this.x0) * (1 - this.kFrictionDamping)), this.start()
    },
...
enyo.kind({
    ...
    scrollToNode: function (e, t) {
        if (this.scrollNode) {
            for (var n = this.getScrollBounds(), i = e, o = {
                    ...
                    top: 0,
                    left: 0
                }; i && i.parentNode && i.id != this.scrollNode.id;) o.top += i.offsetTop, o.left += i.offsetLeft, i = i.parentNode;
            this.setScrollTop(Math.min(n.maxTop, t === !1 ? o.top - n.clientHeight + o.height : o.top)), this.setScrollLeft(Math.min(n.maxLeft, t === !1 ? o.left - n.clientWidth + o.width : o.left))
        }
    },
    ...
    calcStartInfo: function () {
        ...
        this.canVertical = e.maxTop > 0 && "hidden" != this.vertical, this.canHorizontal = e.maxLeft > 0 && "hidden" != this.horizontal, this.startEdges = {
            top: 0 === t,
            bottom: t === e.maxTop,
            left: 0 === n,
            right: n === e.maxLeft
...
enyo.kind({
    ...
    update: function (e) {
        if (this.showing) {
            var t = this.dimension,
                ...
                o = this.scrollBounds[t],
                r = 0,
                s = 0,
                a = 0;
            if (i >= o) return this.hide(), void 0;
            e.isOverscrolling() && (a = e.getOverScrollBounds()["over" + n], r = Math.abs(a), s = Math.max(a, 0));
            var h = e[this.positionMethod]() - a,
                c = i - this.cornerSize,
                u = Math.floor(i * i / o - r);
            u = Math.max(this.minSize, u);
            var l = Math.floor(c * h / o + s);
            l = Math.max(0, Math.min(c - this.minSize, l)), this.needed = i > u, this.needed && this.hasNode() ? (this._pos !== l && (this._pos = l, this.transform ? enyo.dom.transformValue(this, this.translation, l + "px") : "v" == this.axis ? this.setBounds({
                top: l + "px"
            }) : this.setBounds({
                left: l + "px"
    ...
    setShowing: function (e) {
        if (!(e && e != this.showing && this.scrollBounds[this.sizeDimension] >= this.scrollBounds[this.dimension]) && (this.hasNode() && this.cancelDelayHide(), e != this.showing)) {
            var t = this.showing;
...
// ..\source\touch\TouchScrollStrategy.js
enyo.kind({
    ...
    create: enyo.inherit(function (t) {
        return function () {
            t.apply(this, arguments), this.transform = enyo.dom.canTransform(), this.transform || this.overscroll && this.$.client.applyStyle("position", "relative"), this.accel = enyo.dom.canAccelerate();
            var e = "enyo-touch-strategy-container";
            enyo.platform.ios && this.accel && (e += " enyo-composite"), this.scrimChanged(), this.intervalChanged(), this.fixedTimeChanged(), this.frameChanged(), this.container.addClass(e), this.translation = this.accel ? "translate3d" : "translate"
        }
    }),
    ...
    rendered: enyo.inherit(function (t) {
        return function () {
            t.apply(this, arguments), enyo.makeBubble(this.$.client, "scroll"), this.calcBoundaries(), this.syncScrollMath(), this.thumb && this.alertThumbs()
        }
    }),
    ...
    shouldDrag: function (t, e) {
        ...
        var n = e.vertical,
            ...
            o = this.$.scrollMath.vertical && n,
            r = 0 > e.dy,
            s = 0 > e.dx,
            a = !r && this.startEdges.top || r && this.startEdges.bottom,
            h = !s && this.startEdges.left || s && this.startEdges.right;
        return e.boundaryDragger || !i && !o || (e.boundaryDragger = this), !a && o || !h && i ? (e.dragger = this, !0) : void 0
    },
    flick: function (t, e) {
    ...
    dragstart: function (t, e) {
        return !this.dragDuringGesture && e.srcEvent.touches && e.srcEvent.touches.length > 1 ? !0 : (this.doShouldDrag(e), this.dragging = e.dragger == this || !e.dragger && e.boundaryDragger == this, this.dragging && (e.preventDefault(), this.syncScrollMath(), this.$.scrollMath.startDrag(e), this.preventDragPropagation) ? !0 : void 0)
    },
    drag: function (t, e) {
        return this.listReordering ? !1 : (this.dragging && (e.preventDefault(), this.$.scrollMath.drag(e), this.scrim && this.$.scrim.show()), void 0)
    },
    ...
    mousewheel: function (t, e) {
        return !this.dragging && this.useMouseWheel && (this.calcBoundaries(), this.syncScrollMath(), this.stabilize(), this.$.scrollMath.mousewheel(e)) ? (e.preventDefault(), !0) : void 0
    },
    scrollMathStart: function () {
        this.scrollNode && (this.calcBoundaries(), this.thumb && this.showThumbs())
    },
    scrollMathScroll: function (t) {
        this.overscroll ? this.effectScroll(-t.x, -t.y) : this.effectScroll(-Math.min(t.leftBoundary, Math.max(t.rightBoundary, t.x)), -Math.min(t.topBoundary, Math.max(t.bottomBoundary, t.y))), this.thumb && this.updateThumbs()
    },
    ...
    effectScroll: function (t, e) {
        this.scrollNode && (this.scrollLeft = this.scrollNode.scrollLeft = t, this.scrollTop = this.scrollNode.scrollTop = e, this.effectOverscroll(Math.round(t), Math.round(e)))
    },
    ...
    effectOverscroll: function (t, e) {
        var n = this.scrollNode,
            ...
            o = "0",
            r = this.accel ? ",0" : "";
        null !== e && Math.abs(e - n.scrollTop) > 1 && (o = n.scrollTop - e), null !== t && Math.abs(t - n.scrollLeft) > 1 && (i = n.scrollLeft - t), this.transform ? enyo.dom.transformValue(this.$.client, this.translation, i + "px, " + o + "px" + r) : this.$.client.setBounds({
            left: i + "px",
            top: o + "px"
        })
    },
...
// ..\source\touch\TranslateScrollStrategy.js
enyo.kind({
    ...
    scrollMathStart: enyo.inherit(function (t) {
        return function () {
            t.apply(this, arguments), this.scrollStarting = !0, this.startX = 0, this.startY = 0, !this.translateOptimized && this.scrollNode && (this.startX = this.getScrollLeft(), this.startY = this.getScrollTop())
        }
    }),
    scrollMathScroll: function (t) {
        this.overscroll ? (this.scrollLeft = -t.x, this.scrollTop = -t.y) : (this.scrollLeft = -Math.min(t.leftBoundary, Math.max(t.rightBoundary, t.x)), this.scrollTop = -Math.min(t.topBoundary, Math.max(t.bottomBoundary, t.y))), this.isScrolling() && (this.$.scrollMath.isScrolling() && this.effectScroll(this.startX - this.scrollLeft, this.startY - this.scrollTop), this.thumb && this.updateThumbs())
    },
    effectScroll: function (t, e) {
    ...
    effectScrollStop: function () {
        if (!this.translateOptimized) {
            ...
            enyo.dom.transformValue(this.$.client, this.translation, i ? null : t), this.setScrollLeft(this.scrollLeft), this.setScrollTop(this.scrollTop), i && enyo.dom.transformValue(this.$.client, this.translation, t)
        }
    },
    twiddle: function () {
...
// ..\source\touch\TransitionScrollStrategy.js
enyo.kind({
    ...
    setScrollLeft: function (t) {
        ...
        this.stop(), this.scrollLeft = t, (this.isInLeftOverScroll() || this.isInRightOverScroll()) && (this.scrollLeft = e), this.effectScroll()
    },
    setScrollTop: function (t) {
        var e = this.scrollTop;
        this.stop(), this.scrollTop = t, (this.isInTopOverScroll() || this.isInBottomOverScroll()) && (this.scrollTop = e), this.effectScroll()
    },
    ...
    mousewheel: function (t, e) {
        if (!this.dragging && this.useMouseWheel) {
            ...
            var n = this.vertical ? e.wheelDeltaY || e.wheelDelta : 0,
                i = parseFloat(this.getScrollTop()) + -1 * parseFloat(n);
            return i = this.bottomBoundary > -1 * i ? -1 * this.bottomBoundary : this.topBoundary > i ? this.topBoundary : i, this.setScrollTop(i), this.doScroll(), e.preventDefault(), !0
        }
    },
    scroll: function () {
    ...
    updateX: function () {
        ...
        return t = void 0 === t ? 0 : t.split(")")[0].split(",")[4], -1 * parseFloat(t) === this.scrollLeft ? !1 : (this.scrollLeft = -1 * parseFloat(t), !0)
    },
    updateY: function () {
        var t = window.getComputedStyle(this.$.client.node, null).getPropertyValue(enyo.dom.getCssTransformProp()).split("(")[1];
        return t = void 0 === t ? 0 : t.split(")")[0].split(",")[5], -1 * parseFloat(t) === this.scrollTop ? !1 : (this.scrollTop = -1 * parseFloat(t), !0)
    },
    ...
    shouldDragVertical: function (t) {
        var e = this.canDragVertical(t),
            n = this.oobVertical(t);
        return !t.boundaryDragger && e && (t.boundaryDragger = this), !n && e ? (t.dragger = this, !0) : void 0
    },
    shouldDragHorizontal: function (t) {
        var e = this.canDragHorizontal(t),
            n = this.oobHorizontal(t);
        return !t.boundaryDragger && e && (t.boundaryDragger = this), !n && e ? (t.dragger = this, !0) : void 0
    },
    ...
    drag: function (t, e) {
        return this.listReordering ? !1 : (this.dragging && (e.preventDefault(), this.scrollLeft = this.scrollHorizontal ? this.calculateDragDistance(parseInt(this.getScrollLeft(), 10), -1 * (e.pageX - this.prevX), this.leftBoundary, this.rightBoundary) : this.getScrollLeft(), this.scrollTop = this.scrollVertical ? this.calculateDragDistance(this.getScrollTop(), -1 * (e.pageY - this.prevY), this.topBoundary, this.bottomBoundary) : this.getScrollTop(), this.effectScroll(), this.scroll(), this.prevY = e.pageY, this.prevX = e.pageX, this.resetBoundaryX(), this.resetBoundaryY()), void 0)
    },
    ...
    dragfinish: function (t, e) {
        this.dragging && (e.preventTap(), this.dragging = !1, this.isScrolling() || this.correctOverflow(), this.scrim && this.$.scrim.hide())
    },
    correctOverflow: function () {
        if (this.isInOverScroll()) {
            var t = this.scrollHorizontal ? this.correctOverflowX() : !1,
                e = this.scrollVertical ? this.correctOverflowY() : !1;
            t !== !1 && e !== !1 ? (this.scrollLeft = t !== !1 ? t : this.getScrollLeft(), this.scrollTop = e !== !1 ? e : this.getScrollTop(), this.startOverflowScrolling()) : t !== !1 ? (this.scrollLeft = t, this.scrollTop = this.targetScrollTop || this.scrollTop, this.targetScrollLeft = this.getScrollLeft(), this.vertical ? this.startScrolling() : this.startOverflowScrolling()) : e !== !1 && (this.scrollTop = e, this.scrollLeft = this.targetScrollLeft || this.scrollLeft, this.targetScrollTop = this.getScrollTop(), this.scrollHorizontal ? this.startScrolling() : this.startOverflowScrolling())
        }
    },
    ...
    resetCSSTranslationVals: function () {
        var t = enyo.dom.getCssTransformProp(),
            e = window.getComputedStyle(this.$.client.node, null).getPropertyValue(t).split("(")[1].split(")")[0].split(",");
...
enyo.kind({
    ...
    statics: {
        ...
        hasTouchScrolling: function () {
            for (var t, e = 0; t = this.osInfo[e]; e++)
                if (enyo.platform[t.os]) return !0;
            return (enyo.platform.ie >= 10 || enyo.platform.windowsPhone >= 8) && enyo.platform.touch ? !0 : void 0
        },
        hasNativeScrolling: function () {
            for (var t, e = 0; t = this.osInfo[e]; e++)
                if (enyo.platform[t.os] < t.version) return !1;
            return !0
        },
    ...
    decorateBounds: function (t) {
        ...
        t.xDir = 0 > e ? 1 : e > 0 ? -1 : 0, t.yDir = 0 > n ? 1 : n > 0 ? -1 : 0, this.scrollLeft = t.left, this.scrollTop = t.top
    },
    ...
    scroll: function (t, e) {
        var n;
        return n = e.dispatchTarget ? this.preventScrollPropagation && !(e.originator == this || e.originator.owner == this.$.strategy) : this.shouldStopScrollEvent(e), n ? !0 : (this.decorateScrollEvent(e), !1)
    },
...
enyo.kind({
    ...
    play: function (t) {
        return this.stop(), this.reversed = !1, t && enyo.mixin(this, t), this.t0 = this.t1 = enyo.perfNow(), this.value = this.startValue, enyo.jobs.registerPriority(5, this.id), this.job = !0, this.next(), this
    },
    stop: function () {
    ...
    next: function () {
        ...
        1 === e ? (t = this.fraction = enyo.easedLerp(this.t0, this.duration, this.easingFunction, this.reversed), this.value = this.startValue + t * (this.endValue - this.startValue)) : this.value = enyo.easedComplexLerp(this.t0, this.duration, this.easingFunction, this.reversed, this.dt, this.startValue, this.endValue - this.startValue), t >= 1 && 1 === e || this.shouldEnd() ? (this.value = this.endValue, this.fraction = 1, this.fire("onStep"), this.cancel(), this.fire("onEnd")) : (this.fire("onStep"), this.requestNext())
    },
    fire: function (t) {
        var e = this[t];
...
enyo.kind({
    ...
    create: enyo.inherit(function (t) {
        return function () {
            this.noEvents && (delete this.attributes.onload, delete this.attributes.onerror), t.apply(this, arguments), this.altChanged(), this.sizingChanged()
        }
    }),
    ...
    sizingChanged: function (t) {
        this.tag = this.sizing ? "div" : "img", this.addRemoveClass("sized", !! this.sizing), this.inOld && this.removeClass(t), this.sizing && this.addClass(this.sizing), this.generated && (this.srcChanged(), this.render())
    },
...
enyo.kind({
    ...
    create: enyo.inherit(function (t) {
        return function () {
            enyo.platform.ie && (this.handlers.onkeyup = "iekeyup"), enyo.platform.windowsPhone && (this.handlers.onkeydown = "iekeydown"), t.apply(this, arguments), this.placeholderChanged(), this.type && this.typeChanged(), this.valueChanged()
        }
    }),
    rendered: enyo.inherit(function (t) {
        return function () {
            t.apply(this, arguments), enyo.makeBubble(this, "focus", "blur"), 8 == enyo.platform.ie && this.setAttribute("onchange", enyo.bubbler), this.disabledChanged(), this.defaultFocus && this.focus()
        }
    }),
    ...
    iekeydown: function (t, e) {
        var n = enyo.platform.windowsPhone,
            i = e.keyCode,
            o = e.dispatchTarget;
...
enyo.kind({
    ...
    protectedStatics: {
        ...
        hasContentEditable: function () {
            for (var t, e = 0; t = enyo.RichText.osInfo[e]; e++)
                if (enyo.platform[t.os] < t.version) return !1;
            return !0
        }
    },
    ...
    create: enyo.inherit(function (t) {
        return function () {
            this.setTag(enyo.RichText.hasContentEditable() ? "div" : "textarea"), t.apply(this, arguments), this.disabledChanged()
        }
    }),
    ...
    disabledChanged: function () {
        "div" === this.tag ? this.setAttribute("contenteditable", this.disabled ? null : "true") : this.setAttribute("disabled", this.disabled), this.bubble("onDisabledChange")
    },
...
enyo.kind({
    ...
    rendered: enyo.inherit(function (t) {
        return function () {
            t.apply(this, arguments), 8 == enyo.platform.ie && this.setAttribute("onchange", enyo.bubbler), this.selectedChanged()
        }
    }),
...
enyo.kind({
    ...
    initComponents: enyo.inherit(function (t) {
        return function () {
            this.itemComponents = this.components || this.kindComponents, this.components = this.kindComponents = null, t.apply(this, arguments)
        }
    }),
    ...
    decorateEvent: enyo.inherit(function (t) {
        return function (e, n) {
            n && (enyo.exists(n.index) ? (n.indices = n.indices || [n.index], n.indices.push(this.index)) : n.index = this.index, n.delegate && n.delegate.owner === this && (n.delegate = this.owner)), t.apply(this, arguments)
        }
    })
});
...
enyo.kind({
    ...
    render: enyo.inherit(function (t) {
        return function () {
            this.floating && (enyo.floatingLayer.hasNode() || enyo.floatingLayer.render(), this.parentNode = enyo.floatingLayer.hasNode()), t.apply(this, arguments)
        }
    }),
    destroy: enyo.inherit(function (t) {
        return function () {
...
enyo.kind({
    ...
    select: function (t, e) {
        this.multi ? this.setByKey(t, !this.isSelected(t), e) : this.isSelected(t) || (this.highlander(), this.setByKey(t, !0, e))
    },
    toggle: function (t, e) {
...
enyo.kind({
    ...
    openChanged: function () {
        if (this.$.client.show(), this.hasNode())
            if (this.$.animator.isAnimating()) this.$.animator.reverse();
            else {
                var t = "v" == this.orient,
                    e = t ? "height" : "width",
                    n = t ? "top" : "left";
    ...
    animatorStep: function (t) {
        ...
        if (n) {
            var i = t.position,
                o = this.open ? t.endValue : t.startValue;
            n.style[i] = this.$.client.domStyles[i] = t.value - o + "px"
        }
        return this.container && this.resizeContainer && this.container.resized(), this.doDrawerAnimationStep(), !0
    },
    animatorEnd: function () {
        if (this.open) {
            ...
            var t = "v" == this.orient,
                e = t ? "height" : "width",
                n = t ? "top" : "left",
                i = this.$.client.hasNode();
            i && (i.style[n] = this.$.client.domStyles[n] = null), this.node && (this.node.style[e] = this.domStyles[e] = null)
        } else this.$.client.hide();
        return this.container && this.resizeContainer && this.container.resized(), this.doDrawerAnimationEnd(), !0
    }
});
...
enyo.fullscreen = {
    ...
    requestFullscreen: function (t) {
        return this.getFullscreenControl() || !t.hasNode() ? !1 : (this.requestor = t, this.nativeSupport() ? t.hasNode()[this.requestAccessor]() : this.fallbackRequestFullscreen(), !0)
    },
    cancelFullscreen: function () {
    ...
    fallbackRequestFullscreen: function () {
        ...
        t && (t.prevAddBefore = t.parent.controlAtIndex(t.indexInContainer() + 1), enyo.floatingLayer.hasNode() || enyo.floatingLayer.render(), t.addClass("enyo-fullscreen"), t.appendNodeToParent(enyo.floatingLayer.hasNode()), t.resized(), this.setFullscreenControl(t), this.setFullscreenElement(t.hasNode()))
    },
    fallbackCancelFullscreen: function () {
        var t, e, n = this.fullscreenControl;
        n && (t = n.prevAddBefore ? n.prevAddBefore.hasNode() : null, e = n.parent.hasNode(), n.prevAddBefore = null, n.removeClass("enyo-fullscreen"), t ? n.insertNodeInParent(e, t) : n.appendNodeToParent(e), n.resized(), this.setFullscreenControl(null), this.setFullscreenElement(null))
    },
...
enyo.kind({
    ...
    _rateChange: function (t, e) {
        ...
        i && (e = enyo.mixin(e, this.createEventData()), n = this.calcNumberValueOfPlaybackRate(e.playbackRate), n > 0 && 1 > n ? this.doSlowforward(e) : n > 1 ? this.doFastforward(e) : 0 > n && n >= -1 ? this.doSlowrewind(e) : -1 > n ? this.doRewind(e) : 1 == n && this.doPlay(e))
    },
    _stalled: function () {
        this.doStalled()
    },
    ...
    fastForward: function () {
        ...
        if (t) {
            ...
            case "slowForward":
                this._speedIndex == this._playbackRateArray.length - 1 ? (this.selectPlaybackRateArray("fastForward"), this._speedIndex = 0, this._prevCommand = "fastForward") : (this._speedIndex = this.clampPlaybackRate(this._speedIndex + 1), this._prevCommand = "slowForward");
                break;
            case "pause":
                this.selectPlaybackRateArray("slowForward"), this._speedIndex = 0, this.isPaused() && t.play(), this._prevCommand = "slowForward";
                break;
            case "rewind":
                var e = this.calcNumberValueOfPlaybackRate(this.playbackRate);
                0 > e ? (this.selectPlaybackRateArray("slowForward"), this._prevCommand = "slowForward") : (this.selectPlaybackRateArray("fastForward"), this._prevCommand = "fastForward"), this._speedIndex = 0;
                break;
            case "fastForward":
    ...
    rewind: function () {
        ...
        if (t) {
            switch (this._prevCommand) {
            case "slowRewind":
                this._speedIndex == this._playbackRateArray.length - 1 ? (this.selectPlaybackRateArray("rewind"), this._speedIndex = 0, this._prevCommand = "rewind") : (this._speedIndex = this.clampPlaybackRate(this._speedIndex + 1), this._prevCommand = "slowRewind");
                break;
            case "pause":
                this.selectPlaybackRateArray("slowRewind"), this._speedIndex = 0, this.isPaused() && this.node.duration > this.node.currentTime && t.play(), this._prevCommand = "slowRewind";
                break;
            case "rewind":
    ...
    setPlaybackRate: function (t) {
        ...
        n && (this.stopRewindJob(), this.playbackRate = t += "", e = this.calcNumberValueOfPlaybackRate(t), n.playbackRate = e, enyo.platform.webos || window.PalmSystem || 0 > e && this.beginRewind())
    },
    jumpBackward: function () {
        var t = this.hasNode();
        t && (this.setPlaybackRate(1), t.currentTime -= this.jumpSec, this._prevCommand = "jumpBackward", this.doJumpBackward(enyo.mixin(this.createEventData(), {
            jumpSize: this.jumpSec
        })))
    },
    jumpForward: function () {
        var t = this.hasNode();
        t && (this.setPlaybackRate(1), t.currentTime += this.jumpSec, this._prevCommand = "jumpForward", this.doJumpForward(enyo.mixin(this.createEventData(), {
            jumpSize: this.jumpSec
        })))
    },
...
enyo.kind({
    ...
    create: enyo.inherit(function (t) {
        return function () {
            t.apply(this, arguments), this.posterChanged(), this.showControlsChanged(), this.preloadChanged(), this.autoplayChanged(), this.loopChanged()
        }
    }),
    rendered: enyo.inherit(function (t) {
        return function () {
    ...
    jumpForward: function () {
        var t = this.hasNode();
        t && (this.setPlaybackRate(1), t.currentTime += parseInt(this.jumpSec, 10), this._prevCommand = "jumpForward", this.doJumpForward(enyo.mixin(this.createEventData(), {
            jumpSize: this.jumpSec
        })))
    },
    jumpToStart: function () {
    ...
    metadataLoaded: function (t, e) {
        var n = this.hasNode();
        this.setAspectRatio("none"), n && n.videoWidth && n.videoHeight && (this.setAspectRatio(n.videoWidth / n.videoHeight + ":1"), e = enyo.mixin(e, this.createEventData()))
    },
...
(function (t) {
    t.RepeaterChildSupport = {
        ...
        decorateEvent: t.inherit(function (t) {
            return function (e, n) {
                n.model = this.model, n.child = this, n.index = this.repeater.collection.indexOf(this.model), t.apply(this, arguments)
            }
        }),
        ...
        dispatchEvent: t.inherit(function (e) {
            return function (n, i) {
                return i._fromRepeaterChild || ~t.indexOf(n, this.repeater.selectionEvents) && (this._selectionHandler(), i._fromRepeaterChild = !0), e.apply(this, arguments)
            }
        }),
...
enyo.kind({
    ...
    initComponents: function () {
        ...
        var t = this.kindComponents || this.components || [],
            ...
            n = this.defaultProps ? enyo.clone(this.defaultProps) : this.defaultProps = {};
        n.bindingTransformOwner = this, n.bindingDefaults = this.childBindingDefaults, t && (t.length > 1 ? n.components = t : enyo.mixin(n, t[0]), n.repeater = this, n.owner = e, n.mixins = n.mixins ? n.mixins.concat(this.childMixins) : this.childMixins)
    },
    ...
    refresh: function () {
        return this.hasReset ? (this.startJob("refreshing", function () {
            for (var t, e, n = this.get("data"), i = this.getClientControls(), o = 0; e = n.at(o); ++o) t = i[o], t ? t.set("model", e) : this.add(e, o);
            this.prune()
    ...
    controllerChanged: function () {
        ...
        this.controller = void 0, !t || this.collection && this.collection === t || this.warn("the `controller` property has been deprecated, please update and use `collection` instead - including any bindings currently mapped directly to `controller`"), this.set("collection", t)
    },
    collectionChanged: function (t) {
        if (this.controller && this.controller !== t) return this.controllerChanged();
        var e = this.collection;
        "string" == typeof e && (e = this.collection = enyo.getPath(e)), e && (this.initCollection(e, t), this.controller = e)
    },
    initCollection: function (t, e) {
        var n;
        if (t && t.addListener)
            for (n in this._handlers) t.addListener(n, this._handlers[n]);
        if (e && e.removeListener)
            for (n in this._handlers) e.removeListener(n, this._handlers[n])
    },
    ...
    modelsRemoved: function (t, e, n) {
        if (t == this.collection)
            for (var i, o = enyo.keys(n.records), s = o.length - 1; i = o[s]; --s) this.remove(i), this.deselect(i)
    },
    ...
    select: function (t) {
        var e, n = this.childForIndex(t),
            i = this.collection.at(t),
            o = this._selection;
        if (this.selection) {
            if (this.multipleSelection && !~enyo.indexOf(i, o)) o.push(i);
            else if (!~enyo.indexOf(i, o)) {
                for (; o.length;) e = this.collection.indexOf(o.pop()), this.deselect(e);
                o.push(i)
            }
            n && n.set("selected", !0), this.selectionProperty && (o = this.selectionProperty) && i.set(o, !0), this.notifyObservers("selected")
        }
    },
    deselect: function (t) {
        var e, n = this.getChildForIndex(t),
            i = this.collection.at(t),
            o = this._selection;
        e = enyo.indexOf(i, o), ~e && o.splice(e, 1), n && n.set("selected", !1), this.selectionProperty && i && (o = this.selectionProperty) && i.set(o, !1), this.notifyObservers("selected")
    },
    isSelected: function (t) {
    ...
    deselectAll: function () {
        if (this.selection) {
            this.stopNotifications();
            for (var t, e, n = this._selection; n.length;) t = n.pop(), e = this.collection.indexOf(t), this.deselect(e);
            this.startNotifications()
        }
    },
    selected: function () {
    ...
    var n = t.prototype || t;
    if (e.childMixins && (n.childMixins = n.childMixins ? enyo.merge(n.childMixins, e.childMixins) : e.childMixins.slice(), delete e.childMixins), e.bindings)
        for (var i, o = /controller/g, s = 0; i = e.bindings[s]; ++s)("string" == typeof i.source && o.test(i.source) || o.test(i.from) || "string" == typeof i.target && o.test(i.target) || o.test(i.to)) && (enyo.warn(n.kindName + ".concat: the `controller` property has been deprecated, please use `collection` " + "including any bindings that use `controller`, this is automatically updated for you but will be removed " + "in a future release"), "string" == typeof i.source && (i.source = i.source.replace(o, "collection")), i.from = i.from.replace(o, "collection"), "string" == typeof i.target && (i.target = i.target.replace(o, "collection")), i.to = i.to.replace(o, "collection"))
};
...
enyo.kind({
    ...
    create: enyo.inherit(function (t) {
        return function () {
            this.allowTransitionsChanged(), this.delegate = this.ctor.delegates[this.orientation] || this.base.delegates.vertical, this.delegate.initList && this.delegate.initList(this), t.apply(this, arguments), this.pages = [this.$.page1, this.$.page2]
        }
    }),
    render: enyo.inherit(function (t) {
        return function () {
    ...
    rendered: function () {
        if (this.get("absoluteShowing")) {
            var t = function () {
                this.$.scroller.canGenerate = !0, this.$.scroller.render(), this.delegate.rendered(this), this.hasRendered = !0, this.addClass("rendered"), this.didRender && this.didRender()
            };
    ...
    _absoluteShowingChanged: function () {
        if (this.get("absoluteShowing") && this._showingQueue && this._showingQueue.length) {
            var t, e, n = this._showingQueue,
                i = this._showingQueueMethods;
    ...
    _addToShowingQueue: function (t, e) {
        var n = this._showingQueue || (this._showingQueue = []),
            i = this._showingQueueMethods || (this._showingQueueMethods = {}),
            o = enyo.indexOf(t, n);
    ...
    destroy: enyo.inherit(function (t) {
        return function () {
            this.delegate && this.delegate.destroyList && this.delegate.destroyList(this), this._showingQueue = null, this._showingQueueMethods = null, t.apply(this, arguments)
        }
    }),
    initContainer: enyo.inherit(function (t) {
        return function () {
            var e = enyo.clone(this.get("containerOptions")),
                n = this.get("scrollerOptions");
            n && enyo.mixin(e, n, {
                exists: !0
    ...
    didScroll: function (t, e) {
        return this.hasRendered && this.collection && ((this.heightNeedsUpdate || this.widthNeedsUpdate) && (this.heightNeedsUpdate = this.widthNeedsUpdate = !1, this.refresh()), this.delegate.didScroll(this, e)), !0
    },
    didResize: function (t, e) {
        this.get("absoluteShowing") ? this.hasRendered && this.collection && ((this.heightNeedsUpdate || this.widthNeedsUpdate) && (this.heightNeedsUpdate = this.widthNeedsUpdate = !1, this.refresh()), this.delegate.didResize(this, e)) : this._addToShowingQueue("didResize", this.didResize)
    },
...
enyo.DataList.delegates.vertical = {
    ...
    initList: function (t) {
        t.posProp = "top", t.upperProp = "top", t.lowerProp = "bottom", t.psizeProp = "height", t.ssizeProp = "width";
    ...
    pagesByPosition: function (t) {
        var e = t.metrics.pages,
            n = t.pagePositions || (t.pagePositions = {}),
            i = t.upperProp,
            o = t.$.page1.index,
            s = t.$.page2.index;
        return n.firstPage = e[o][i] < e[s][i] ? t.$.page1 : t.$.page2, n.lastPage = n.firstPage === t.$.page1 ? t.$.page2 : t.$.page1, n
    },
    refresh: function (t) {
        if (!t.hasReset) return this.reset(t);
        var e = Math.max(this.pageCount(t) - 1, 0),
            n = t.$.page1.index,
            i = t.$.page2.index;
        n > e && (n = e), i > e && (i = n + 1 > e && n - 1 >= 0 ? n - 1 : n + 1), t.$.page1.index = n, t.$.page2.index = i;
        for (var o, s = 0; o = t.pages[s]; ++s) this.generatePage(t, o, o.index);
        this.adjustPagePositions(t), this.adjustBuffer(t)
    },
    rendered: function (t) {
        t.$.scroller.addScrollListener && (t.usingScrollListener = !0, t.$.scroller.addScrollListener(enyo.bindSafely(this, "scrollHandler", t))), this.updateBounds(t), t.length && this.reset(t)
    },
    generatePage: function (t, e, n) {
        e.index = n;
        var i, o = t.collection,
            s = t.metrics,
            r = this.controlsPerPage(t);
        e.start = r * n, e.end = Math.min(o.length - 1, e.start + r - 1), t.controlParent = e;
        for (var a = e.start; e.end >= a && o.length > a; ++a) i = e.children[a - e.start] || t.createComponent({}), i.teardownRender(), i.stopNotifications(), i.set("model", o.at(a)), i.set("index", a), i.set("selected", t.isSelected(i.model)), i.startNotifications(), i.canGenerate = !0;
        for (a -= e.start; e.children.length > a; ++a) i = e.children[a], i.teardownRender(), i.canGenerate = !1;
        e.render(), s = s.pages[n] || (s.pages[n] = {}), s.height = this.pageHeight(t, e), s.width = this.pageWidth(t, e), this.childSize(t)
    },
    childSize: function (t) {
        if (!t.fixedChildSize) {
            var e, n, i = t.$.page1.index,
                o = t.psizeProp,
                s = t.$.page1.node || t.$.page1.hasNode();
    ...
    controlsPerPage: function (t) {
        var e = t._updatedControlsPerPage,
            n = t._updatedBounds,
            i = t.childSize,
            o = t.controlsPerPage,
            s = t.psizeProp,
            r = t.pageSizeMultiplier || this.pageSizeMultiplier,
            a = this[s];
        return (!e || n > e) && (i = this.childSize(t), o = t.controlsPerPage = Math.ceil(a(t) * r / i + 1), t._updatedControlsPerPage = enyo.perfNow()), t.controlsPerPage = o
    },
    ...
    scrollToIndex: function (t, e) {
        var n = this.childForIndex(t, e),
            i = this.pageForIndex(t, e);
        0 > i || i > this.pageCount(t) || (n ? t.$.scroller.scrollIntoView(n, this.pagePosition(t, i)) : (this.resetToPosition(t, this.pagePosition(t, i)), enyo.asyncMethod(function () {
            t.scrollToIndex(e)
        })))
    },
    pageHeight: function (t, e) {
        var n = e.node.offsetHeight,
            i = t.metrics.pages[e.index];
        return 0 === n && t.length && e.node.children.length && (t.heightNeedsUpdate = !0, n = i ? i.height : 0), n
    },
    pageWidth: function (t, e) {
        var n = e.node.offsetWidth,
            i = t.metrics.pages[e.index];
        return 0 === n && t.length && e.node.children.length && (t.widthNeedsUpdate = !0, n = i ? i.width : 0), n
    },
    modelsAdded: function (t, e) {
        if (!t.hasReset) return this.reset(t);
        for (var n, i, o, s, r = t.$.page1.index || (t.$.page1.index = 0), a = t.$.page2.index || (t.$.page2.index = 1), h = 0;
            (s = e.records[h]) >= 0; ++h)
            if (o = this.pageForIndex(t, s), o == r) n = !0;
            else if (o == a) i = !0;
        else if (o > a) break;
        n && this.generatePage(t, t.$.page1, r), i && this.generatePage(t, t.$.page2, a), (n || i) && this.adjustPagePositions(t), this.adjustBuffer(t)
    },
    childForIndex: function (t, e) {
        var n = this.pageForIndex(t, e),
            i = t.$.page1,
            o = t.$.page2;
        if (n = n == i.index && i || n == o.index && o)
            for (var s, r = 0; s = n.children[r]; ++r)
                if (s.index == e) return s
    },
    modelsRemoved: function (t, e) {
        for (var n, i, o = enyo.keys(e.records), s = t.$.page1.index, r = t.$.page2.index, a = o.length - 1;
            (i = o[a]) >= 0; --a)
            if (n = this.pageForIndex(t, i), n == s || n == r) {
                this.refresh(t);
    ...
    adjustBuffer: function (t) {
        var e, n = this.pageCount(t),
            i = this.defaultPageSize(t),
            o = 0,
            s = t.psizeProp,
            r = t.ssizeProp,
            a = t.$.buffer.node || t.$.buffer.hasNode();
        if (a) {
            if (0 !== n)
    ...
    adjustPagePositions: function (t) {
        for (var e, n = 0; e = t.pages[n]; ++n) {
            var i = e.index,
                o = this.pagePosition(t, e.index),
                s = t.metrics.pages[i] || (t.metrics.pages[i] = {}),
                r = t.posProp,
                a = t.upperProp,
                h = t.lowerProp,
                l = t.psizeProp;
    ...
    pagePosition: function (t, e) {
        for (var n, i = t.metrics.pages, o = this.defaultPageSize(t), s = 0, r = t.psizeProp; e > 0;) n = i[--e], s += n && n[r] ? n[r] : o;
        return s
    },
    ...
    scrollHandler: function (t, e) {
        var n = this.pageCount(t) - 1,
            i = this.pagesByPosition(t);
        1 !== e.xDir && 1 !== e.yDir || i.lastPage.index === n ? -1 !== e.xDir && -1 !== e.yDir || 0 === i.firstPage.index || (this.generatePage(t, i.lastPage, i.firstPage.index - 1), this.adjustPagePositions(t), t.triggerEvent("paging", {
            start: i.firstPage.start,
            end: i.lastPage.end,
            action: "scroll"
        })) : (this.generatePage(t, i.firstPage, i.lastPage.index + 1), this.adjustPagePositions(t), this.adjustBuffer(t), t.triggerEvent("paging", {
            start: i.firstPage.start,
            end: i.lastPage.end,
            action: "scroll"
        }))
    ...
    setScrollThreshold: function (t) {
        var e = t.scrollThreshold || (t.scrollThreshold = {}),
            n = t.metrics.pages,
            i = this.pagesByPosition(t),
            o = i.firstPage.index,
            s = i.lastPage.index,
            r = this.pageCount(t) - 1,
            a = t.lowerProp,
            h = t.upperProp,
            l = "top" == h ? this.height : this.width;
        e[h] = 0 === o ? void 0 : n[o][h] + this.childSize(t), e[a] = s >= r ? void 0 : n[s][a] - l(t) - this.childSize(t), t.usingScrollListener && t.$.scroller.setScrollThreshold(e)
    },
    resetToPosition: function (t, e) {
        if (e >= 0 && t.bufferSize >= e) {
            var n = Math.ceil(e / this.defaultPageSize(t)),
                i = this.pageCount(t) - 1,
                o = this.pagesByPosition(t);
            (o.firstPage[t.upperProp] >= e || e >= o.lastPage[t.lowerProp]) && (t.$.page1.index = n = Math.min(n, i), t.$.page2.index = n === i ? n - 1 : n + 1, this.refresh(t), t.triggerEvent("paging", {
                    start: t.$.page1.start,
                    end: t.$.page2.end,
                    action: "reset"
                }))
...
(function (t) {
    ...
    t.kind.extendMethods(e, {
        initList: t.inherit(function (e) {
            return function (n) {
                e.apply(this, arguments), n.addClass("horizontal"), n.posProp = n.rtl ? "right" : "left", n.upperProp = "left", n.lowerProp = "right", n.psizeProp = "width", n.ssizeProp = "height";
        ...
        adjustBuffer: t.inherit(function (t) {
            return function (e) {
                t.apply(this, arguments);
                var n = e.$.active.node || e.$.active.hasNode(),
                    i = e.bufferSize;
...
(function (t) {
    ...
    t.kind.extendMethods(e, {
        ...
        pageHeight: function (t, e) {
            var n, i = e.node || e.hasNode(),
                o = i.children.length,
                s = t.metrics.pages[e.index];
            return n = (Math.floor(o / t.columns) + (o % t.columns ? 1 : 0)) * (t.tileHeight + t.spacing), i.style.height = n + "px", s.height = n, n
        },
        ...
        pageWidth: function (t, e) {
            var n = t.boundsCache.width,
                i = e.node || e.hasNode(),
                o = t.metrics.pages[e.index];
        ...
        updateMetrics: function (t) {
            ...
            var e = t.boundsCache,
                ...
                o = t.minWidth,
                s = t.minHeight;
            t.columns = Math.max(Math.floor((n - i) / (o + i)), 1), t.tileWidth = (n - i * (t.columns + 1)) / t.columns, t.tileHeight = s * (t.tileWidth / o), this.controlsPerPage(t)
        },
        controlsPerPage: t.inherit(function (t) {
            return function (e) {
                var n = e._updatedControlsPerPage,
                    i = t.apply(this, arguments);
                return n != e._updatedControlsPerPage && (i = e.controlsPerPage = i * e.columns), i
            }
        }),
        childSize: function (t) {
        ...
        layout: function (t, e) {
            ...
            var n, i = t.columns,
                ...
                l = h.children;
            if (l.length)
                for (var c, d = 0; c = l[d]; ++d) n = d % i, c.addStyles("top: " + Math.round(o + a * (r + o)) + "px; " + (t.rtl ? "right: " : "left: ") + Math.round(o + n * (s + o)) + "px; " + "width: " + Math.round(s) + "px; " + "height: " + Math.round(r) + "px"), 0 === (d + 1) % i && ++a
        },
        adjustBuffer: function (t) {
            var e, n = this.pageCount(t),
                i = this.defaultPageSize(t),
