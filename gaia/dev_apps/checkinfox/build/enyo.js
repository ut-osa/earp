...
(function(e, t) {
    var n, a, o, r, i, c = e.document, d = [], s = "complete" === c.readyState, y = !1;
    t.ready = function(e, t) {
        d.push([ e, t ]), s && !y && (setTimeout(i, 0), y = !0);
    }, n = function(e, n) {
        e.call(n || t.global);
    }, a = function(e) {
        (s = "interactive" === c.readyState) && "DOMContentLoaded" !== e.type && "readystatechange" !== e.type && (o(e.type, a), 
        i()), (s = "complete" === c.readyState || "loaded" === c.readyState) && (o(e.type, a), 
        i());
    }, r = function(e, t) {
        var n = c.addEventListener ? "addEventListener" : "attachEvent", a = "attachEvent" === n ? "on" : "";
        c[n](a + e, t, !1);
    }, o = function(e, t) {
        var n = c.addEventListener ? "removeEventListener" : "detachEvent", a = "detachEvent" === n ? "on" : "";
        c[n](a + e, t, !1);
    }, i = function() {
        if (s && d.length) for (;d.length; ) n.apply(e, d.shift());
        y = !1;
...
(function() {
    enyo = window.enyo || {
        ...
        decodePackagePath: function(e) {
            var t = "", a = "package.js";
            /^\/\//.test(e) && (e = document.location.protocol + e);
            var i = e.replace(/\\/g, "/").replace(/\/\//g, "/").replace(/:\//, "://").split("/");
            if (i.length) {
                var n = i.pop() || i.pop() || "";
...
(function(e) {
    var t = function(t, n) {
        var o, i = t._appliedMixins, r = n;
        if (e.isString(r) && (r = e.getPath(r), !r)) return e.warn("could not find the requested mixin " + n), 
        void 0;
        if (r.name) {
            if (~e.indexOf(r.name, i)) return e.warn("attempt to add the same mixin more than once, " + r.name + " onto -> " + t.kindName), 
            void 0;
            i.push(r.name), o = r.name, delete r.name;
        } else o = null;
        var s = e.clone(r);
        r.hasOwnProperty("constructor") && (s._constructor = r.constructor, delete s.constructor), 
        e.kind.statics.extend(s, t), o && (r.name = o);
    }, n = function(n, o) {
        if (o.mixins) {
            var i = n.prototype || n, r = o.mixins;
            i._appliedMixins = i._appliedMixins ? e.cloneArray(i._appliedMixins) : [], delete o.mixins;
            for (var s, a = 0; s = r[a]; ++a) t(i, s);
        }
    };
    e.kind.features.push(n);
    var o = e.concatHandler;
    e.concatHandler = function(e, t) {
        ...
        extend: e.inherit(function(t) {
            return function(o, i) {
                var r = i || this.prototype;
                return o.mixins && (r.mixins = e.merge(r.mixins, o.mixins), n(r, o)), t.apply(this, arguments);
            };
        })
    }, !0), e.MixinSupport = {
        name: "MixinSupport",
...
enyo.kind({
    ...
    create: enyo.inherit(function(e) {
        return function() {
            ...
            e.apply(this, arguments), this.layoutKindChanged();
        };
    }),
    destroy: enyo.inherit(function(e) {
        return function() {
...
(function(e) {
    ...
    e.ready(function() {
        ...
        addRoute: function(e) {
            ...
            return !0 === e["default"] ? this.defaultRoute = e : i.test(e.path) ? (i.lastIndex = 0, 
            t = RegExp(e.path.replace(i, "([a-zA-Z0-9-]*)")), e.regex = t, o.push(e)) : n[e.path] = e, 
            this;
        },
...
enyo.macroize = function(e, t, n) {
    ...
    do if (o = !1, r = r.replace(s, a), ++u >= 20) throw "enyo.macroize: recursion too deep"; while (o);
    return r;
...
(function() {
    ...
    }, document.addEventListener && document.addEventListener("localechange", function() {
        enyo.updateLocale();
    }, !1);
})();
...
(function(e) {
    e.kind({
        ...
        find: function(t, n) {
            ...
            var i = e.isString(t) ? e.constructorForKind(t) : t, o = i.prototype, r = n, s = r.attributes, a = this.sources, u = this.records, c = o.primaryKey, h = r.source && (e.isString(r.source) && a[r.source] || r.source) || a[o.defaultSource], l = r.euid && u.euid[r.euid] || s && s[c] && u.pk[o.kindName][s[c]];
        ...
        findLocal: function(t, n, i) {
            ...
            var o, r = ("string" == typeof t ? e.constructorForKind(t) : t).prototype, s = this.records, a = r ? r.primaryKey : "", u = n[a];
            return n.euid ? s.euid[n.euid] : void 0 !== u && null !== u ? (o = s.pk[r.kindName], 
            o && o[u] || void 0) : n.kindName ? (o = s.kn[n.kindName], o && e.values(o) || []) : (i = i && ("string" == typeof i && this[i] || i) || this.filter, 
            ...
            if (this.attributes) {
                ...
                if (i || s !== n) {
                    if (this.previous[t] = s, this.computedMap && (r = this.computedMap[t])) {
                        ...
                        for (var a, u = 0; a = r[u]; ++u) this.attributes[t] = s, this.previous[a] = o[a] = this.get(a), 
                    ...
                    o) for (var c in o) this.notifyObservers(c, this.previous[c], o[c]);
...
enyo.kind({
    ...
    reset: function(e) {
        var t, n = !1;
        return e && enyo.isArray(e) && (t = this.records.length, this.records = e.slice(), 
        this.length = this.records.length, n = !0), n && (t !== this.length && this.notifyObservers("length", t, this.length), 
    ...
    constructor: enyo.inherit(function(e) {
        return function(t, n) {
            ...
            var r = this.model;
            this.model = r && enyo.isString(r) ? enyo.getPath(r) : enyo.checkConstructor(r), 
            this.storeChanged(), t = n = void 0, e.apply(this, arguments);
        };
    }),
    destroy: enyo.inherit(function(e) {
        return function() {
...
enyo.requiresWindow = function(e) {
    ...
    getComputedStyleValue: function(e, t, n) {
        var i = n || this.getComputedStyle(e), o = enyo.platform.ie;
    ...
    applyBodyFit: function() {
        ...
        e && this.addClass(e, "enyo-document-fit"), enyo.dom.addBodyClass("enyo-body-fit"), 
    ...
    _ieCssToPixelValue: function(e, t) {
        var n = t, i = e.style, o = i.left, r = e.runtimeStyle && e.runtimeStyle.left;
        return r && (e.runtimeStyle.left = e.currentStyle.left), i.left = n, n = i.pixelLeft, 
        i.left = o, r && (i.runtimeStyle.left = r), n;
    },
    _pxMatch: /px/i,
    ...
    calcNodePosition: function(e, t) {
        var n = 0, i = 0, o = e, r = o.offsetWidth, s = o.offsetHeight, a = enyo.dom.getStyleTransformProp(), c = /translateX\((-?\d+)px\)/i, u = /translateY\((-?\d+)px\)/i, h = 0, d = 0, l = 0, f = 0, y = 0, p = 0;
        if (t ? (l = t.offsetHeight, f = t.offsetWidth) : (l = document.body.parentNode.offsetHeight > this.getWindowHeight() ? this.getWindowHeight() - document.body.parentNode.scrollTop : document.body.parentNode.offsetHeight, 
        f = document.body.parentNode.offsetWidth > this.getWindowWidth() ? this.getWindowWidth() - document.body.parentNode.scrollLeft : document.body.parentNode.offsetWidth), 
        o.offsetParent) do t && 8 & this.compareDocumentPosition(t, o.offsetParent) && (y = t.offsetLeft, 
        p = t.offsetTop), i += o.offsetLeft - (o.offsetParent ? o.offsetParent.scrollLeft : 0) - y, 
        a && c.test(o.style[a]) && (i += parseInt(o.style[a].replace(c, "$1"), 10)), n += o.offsetTop - (o.offsetParent ? o.offsetParent.scrollTop : 0) - p, 
        a && u.test(o.style[a]) && (n += parseInt(o.style[a].replace(u, "$1"), 10)), o !== e && (o.currentStyle ? (h = parseInt(o.currentStyle.borderLeftWidth, 10), 
        d = parseInt(o.currentStyle.borderTopWidth, 10)) : window.getComputedStyle ? (h = parseInt(window.getComputedStyle(o, "").getPropertyValue("border-left-width"), 10), 
        d = parseInt(window.getComputedStyle(o, "").getPropertyValue("border-top-width"), 10)) : (h = parseInt(o.style.borderLeftWidth, 10), 
        d = parseInt(o.style.borderTopWidth, 10)), h && (i += h), d && (n += d)); while ((o = o.offsetParent) && (!t || 16 & this.compareDocumentPosition(t, o)));
        return {
            top: n,
            left: i,
            bottom: l - n - s,
    ...
    getAbsoluteBounds: function(e) {
        for (var t = e, n = 0, i = 0, o = t.offsetWidth, r = t.offsetHeight, s = enyo.dom.getStyleTransformProp(), a = /translateX\((-?\d+|-?\d*\.\d+)px\)/i, c = /translateY\((-?\d+|-?\d*\.\d+)px\)/i, u = /(?!matrix3d\()(-?\d+|-?\d*\.\d+)(?=[,\)])/g, h = null, d = null, l = null; t; ) t.offsetParent != l && (enyo.platform.firefox ? (n += t.offsetLeft, 
        i += t.offsetTop) : (n += t.offsetLeft - (t.offsetParent ? t.offsetParent.scrollLeft : 0), 
        i += t.offsetTop - (t.offsetParent ? t.offsetParent.scrollTop : 0)), l = t.offsetParent), 
        s && t.style && (d = t.style[s], h = d.match(a), h && h[1] !== void 0 && h[1] && (n += parseInt(h[1], 10)), 
        h = d.match(c), h && h[1] !== void 0 && h[1] && (i += parseInt(h[1], 10)), h = d.match(u), 
        h && 16 === h.length && (h[12] !== void 0 && "0" !== h[12] && (n += parseFloat(h[12])), 
        h[13] !== void 0 && "0" !== h[13] && (i += parseFloat(h[13])))), t = t.parentNode;
        return {
            top: e ? i : void 0,
            left: e ? n : void 0,
...
enyo.kind({
    ...
    showingChanged: function(e) {
        this.syncDisplayToShowing(), this.sendShowingChangedEvent(e);
    },
    sendShowingChangedEvent: function(e) {
    ...
    getAbsoluteShowing: function(e) {
        var t;
        return e || (t = this.getBounds()), !this.generated || this.destroyed || !this.getShowing() || t && 0 === t.height && 0 === t.width ? !1 : this.parent && this.parent.getAbsoluteShowing && this.parentNode !== enyo.floatingLayer.hasNode() ? this.parent.getAbsoluteShowing(e) : !0;
    },
    ...
    statics: {
        ...
        cssTextToDomStyles: function(e, t, n) {
            if (e) for (var i, o, r, s, a = e.replace(/;$/, "").split(/\s*;[\s;]*/), u = 0; s = a[u]; u++) i = s.split(/\s*:\s*/), 
...
(function() {
    ...
    }, c = 0, h = o.length; ((e = o[c]) || h > c) && !(enyo.platform.ios >= 6); c++) if (t = e ? e + enyo.cap(s) : s, 
    n = e ? e + enyo.cap(r) : r, window[t]) {
        u = window[t], a = window[n], "webkit" == e && u(a(enyo.nop));
        break;
    }
...
enyo.kind({
    ...
    create: enyo.inherit(function(t) {
        return function() {
            ...
            var e = "v" == this.axis;
            this.dimension = e ? "height" : "width", this.offset = e ? "top" : "left", this.translation = e ? "translateY" : "translateX", 
            this.positionMethod = e ? "getScrollTop" : "getScrollLeft", this.sizeDimension = e ? "clientHeight" : "clientWidth", 
    ...
    update: function(t) {
        if (this.showing) {
            var e = this.dimension, n = this.offset, i = this.scrollBounds[this.sizeDimension], o = this.scrollBounds[e], r = 0, s = 0, a = 0;
            if (i >= o) return this.hide(), void 0;
            t.isOverscrolling() && (a = t.getOverScrollBounds()["over" + n], r = Math.abs(a), 
            s = Math.max(a, 0));
            var h = t[this.positionMethod]() - a, c = i - this.cornerSize, u = Math.floor(i * i / o - r);
            u = Math.max(this.minSize, u);
            var d = Math.floor(c * h / o + s);
            d = Math.max(0, Math.min(c - this.minSize, d)), this.needed = i > u, this.needed && this.hasNode() ? (this._pos !== d && (this._pos = d, 
            this.transform ? enyo.dom.transformValue(this, this.translation, d + "px") : "v" == this.axis ? this.setBounds({
                top: d + "px"
            }) : this.setBounds({
                left: d + "px"
            })), this._size !== u && (this._size = u, this.node.style[e] = this.domStyles[e] = u + "px")) : this.hide();
        }
    },
    setShowing: function(t) {
        if (!(t && t != this.showing && this.scrollBounds[this.sizeDimension] >= this.scrollBounds[this.dimension]) && (this.hasNode() && this.cancelDelayHide(), 
        t != this.showing)) {
            var e = this.showing;
    ...
    delayHide: function(t) {
        this.showing && enyo.job(this.id + "hide", this.bindSafely("hide"), t || 0);
    },
...
enyo.kind({
    ...
    rendered: enyo.inherit(function(t) {
        return function() {
            t.apply(this, arguments), this.collection && this.collection.length && this.reset(), 
            this.hasRendered = !0;
        };
    }),
    add: function(t, e) {
    ...
    prune: function() {
        var t, e = this.getClientControls(), n = this.collection ? this.collection.length : 0;
        if (e.length > n) {
            t = e.slice(n);
            for (var i, o = 0; i = t[o]; ++o) i.destroy();
        }
    },
    ...
    _select: function(t, e, n) {
        if (this.selection) {
            var i = this.getChildForIndex(t), o = this._selection, s = enyo.indexOf(e, o);
            if (n) {
                if (-1 == s) {
                    if (!this.multipleSelection) for (;o.length; ) s = this.collection.indexOf(o.pop()), 
                    this.deselect(s);
                    o.push(e);
                }
            } else s >= 0 && o.splice(s, 1);
            i && i.set("selected", n), this.selectionProperty && e && (o = this.selectionProperty) && e.set(o, n), 
            this.notifyObservers("selected");
        }
    },
    select: function(t) {
        this._select(t, this.collection.at(t), !0);
    },
    deselect: function(t) {
        this._select(t, this.collection.at(t), !1);
    },
    isSelected: function(t) {
    ...
    selectAll: function() {
        if (this.multipleSelection) {
            ...
            var t = this._selection, e = this.collection ? this.collection.length : 0;
            t.length = 0;
            for (var n = 0; e > n; ++n) this.select(n);
    ...
    var n = t.prototype || t;
    e.childMixins && (n.childMixins = n.childMixins ? enyo.merge(n.childMixins, e.childMixins) : e.childMixins.slice(), 
    delete e.childMixins);
};
...
enyo.kind({
    ...
    scrollToIndex: function(t) {
        var e = this.collection ? this.collection.length : 0;
        t >= 0 && e > t && (this.get("absoluteShowing") ? this.delegate.scrollToIndex(this, t) : this._addToShowingQueue("scrollToIndex", function() {
    ...
    modelsRemoved: enyo.inherit(function(t) {
        return function(e, n, i) {
            e === this.collection && this.$.scroller.canGenerate && (this.get("absoluteShowing") ? this.delegate.modelsRemoved(this, i) : this._addToShowingQueue("refresh", function() {
                this.refresh();
            })), t.apply(this, arguments);
        };
    }),
...
enyo.DataList.delegates.vertical = {
    ...
    rendered: function(t) {
        ...
        this.updateBounds(t), t.collection && t.collection.length && this.reset(t);
    },
    ...
    pageHeight: function(t, e) {
        var n = e.node.offsetHeight, i = t.metrics.pages[e.index], o = t.collection ? t.collection.length : 0;
        return 0 === n && o && e.node.children.length && (t.heightNeedsUpdate = !0, n = i ? i.height : 0), 
        n;
    },
    pageWidth: function(t, e) {
        var n = e.node.offsetWidth, i = t.metrics.pages[e.index], o = t.collection ? t.collection.length : 0;
        return 0 === n && o && e.node.children.length && (t.widthNeedsUpdate = !0, n = i ? i.width : 0), 
        n;
    },
    ...
    pageCount: function(t) {
        var e = t.controlsPerPage || this.controlsPerPage(t), n = t.collection ? t.collection.length : 0;
...
enyo.kind({
    ...
    showingChanged: enyo.inherit(function(t) {
        return function() {
            t.apply(this, arguments);
            var e = this.collection ? this.collection.length : 0;
            this.$.scroller.generated && e && this.showing && this.didResize();
        };
    }),
    noDefer: !0,
...
(function(t) {
    ...
    t.kind.extendMethods(e, {
        rendered: function(t) {
            this.updateMetrics(t), t.collection && t.collection.length && this.reset(t);
        },
